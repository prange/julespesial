...
public class CheckResults {
    ...
    public static Show<Arg<?>> argReflectionShow() {
        return Show.showS( new Func<Arg<?>, String>() {
            @Override
    ...
    public static <T> Show<T> reflectionShow() {
        return Show.showS( new Func<T, String>() {
            @Override
            public String f(T t) {
    ...
    public static void assertResults(final List<P2<String, CheckResult>> results) {
        ...
        List<String> resultSummary = results.filter( new Func<P2<String, CheckResult>, Boolean>() {
        ...
        } ).map( new Func<P2<String, CheckResult>, String>() {
