...
public abstract class P5<A, B, C, D, E> {
   ...
   */
  public final <X> P5<X, B, C, D, E> map1(final Func<A, X> f) {
   ...
   * @return A product with the given function applied.
   */
  public final <X> P5<A, X, C, D, E> map2(final Func<B, X> f) {
   ...
   * @return A product with the given function applied.
   */
  public final <X> P5<A, B, X, D, E> map3(final Func<C, X> f) {
   ...
   * @return A product with the given function applied.
   */
  public final <X> P5<A, B, C, X, E> map4(final Func<D, X> f) {
   ...
   * @return A product with the given function applied.
   */
  public final <X> P5<A, B, C, D, X> map5(final Func<E, X> f) {
   ...
   */
  public static <A, B, C, D, E> Func<P5<A, B, C, D, E>, A> __1() {
    return new Func<P5<A, B, C, D, E>, A>() {
   ...
   */
  public static <A, B, C, D, E> Func<P5<A, B, C, D, E>, B> __2() {
    return new Func<P5<A, B, C, D, E>, B>() {
   ...
   */
  public static <A, B, C, D, E> Func<P5<A, B, C, D, E>, C> __3() {
    return new Func<P5<A, B, C, D, E>, C>() {
   ...
   */
  public static <A, B, C, D, E> Func<P5<A, B, C, D, E>, D> __4() {
    return new Func<P5<A, B, C, D, E>, D>() {
   ...
   */
  public static <A, B, C, D, E> Func<P5<A, B, C, D, E>, E> __5() {
    return new Func<P5<A, B, C, D, E>, E>() {
