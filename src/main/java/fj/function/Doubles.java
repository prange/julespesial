...
public final class Doubles {
   ...
   */
  public static final Func<Double, Func<Double, Double>> add = doubleAdditionSemigroup.sum();

  /**
   * Curried Double multiplication.
   */
  public static final Func<Double, Func<Double, Double>> multiply = doubleMultiplicationSemigroup.sum();

  /**
   * Curried Double subtraction.
   */
  public static final Func<Double, Func<Double, Double>> subtract = curry(new Func2<Double, Double, Double>() {
   ...
   * Negation.
   */
  public static final Func<Double, Double> negate = new Func<Double, Double>() {
   ...
   * Absolute value.
   */
  public static final Func<Double, Double> abs = new Func<Double, Double>() {
    public Double f(final Double x) {
      return abs(x);
    }
  };
   ...
   * Remainder.
   */
  public static final Func<Double, Func<Double, Double>> remainder = curry(new Func2<Double, Double, Double>() {
   ...
   * Power.
   */
  public static final Func<Double, Func<Double, Double>> power = curry(new Func2<Double, Double, Double>() {
    public Double f(final Double a, final Double b) {
   ...
   * Evenness.
   */
  public static final Func<Double, Boolean> even = new Func<Double, Boolean>() {
   ...
   */
  public static Func<String, Option<Double>> fromString() {
    return new Func<String, Option<Double>>() {
   ...
   */
  public static final Func<Double, Boolean> gtZero = new Func<Double, Boolean>() {
    public Boolean f(final Double i) {
   ...
   */
  public static final Func<Double, Boolean> gteZero = new Func<Double, Boolean>() {
    public Boolean f(final Double i) {
      return Double.compare(i, 0) >= 0;
    }
  };
   ...
   */
  public static final Func<Double, Boolean> ltZero = new Func<Double, Boolean>() {
    public Boolean f(final Double i) {
      return Double.compare(i, 0) < 0;
    }
  };
   ...
   */
  public static final Func<Double, Boolean> lteZero = new Func<Double, Boolean>() {
    public Boolean f(final Double i) {
      return Double.compare(i, 0) <= 0;
    }
  };
