...
public final class BigIntegers {
   ...
   */
  public static final Func<BigInteger, Func<BigInteger, BigInteger>> add =
      curry(new Func2<BigInteger, BigInteger, BigInteger>() {
   ...
   */
  public static final Func<BigInteger, Func<BigInteger, BigInteger>> multiply =
      curry(new Func2<BigInteger, BigInteger, BigInteger>() {
        public BigInteger f(final BigInteger a1, final BigInteger a2) {
   ...
   */
  public static final Func<BigInteger, Func<BigInteger, BigInteger>> subtract =
      curry(new Func2<BigInteger, BigInteger, BigInteger>() {
        public BigInteger f(final BigInteger a1, final BigInteger a2) {
   ...
   * Negation.
   */
  public static final Func<BigInteger, BigInteger> negate = new Func<BigInteger, BigInteger>() {
   ...
   * Absolute value.
   */
  public static final Func<BigInteger, BigInteger> abs = new Func<BigInteger, BigInteger>() {
    public BigInteger f(final BigInteger i) {
      return i.abs();
    }
  };
   ...
   * Remainder.
   */
  public static final Func<BigInteger, Func<BigInteger, BigInteger>> remainder =
      curry(new Func2<BigInteger, BigInteger, BigInteger>() {
        public BigInteger f(final BigInteger a1, final BigInteger a2) {
   ...
   * Power.
   */
  public static final Func<BigInteger, Func<Integer, BigInteger>> power = curry(new Func2<BigInteger, Integer, BigInteger>() {
