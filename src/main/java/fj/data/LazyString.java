...
public final class LazyString implements CharSequence {
  ...
  public static LazyString str(final String s) {
    return new LazyString(Stream.unfold(new Func<P2<String, Integer>, Option<P2<Character, P2<String, Integer>>>>() {
   ...
   */
  public static Func<LazyString, Func<LazyString, Boolean>> startsWith() {
    return curry(new Func2<LazyString, LazyString, Boolean>() {
   ...
   */
  public Stream<LazyString> split(final Func<Character, Boolean> p) {
   ...
   */
  public static final Func<LazyString, Stream<Character>> toStream =
      new Func<LazyString, Stream<Character>>() {
   ...
   */
  public static final Func<LazyString, String> toString =
      new Func<LazyString, String>() {
   ...
   */
  public static final Func<Stream<Character>, LazyString> fromStream =
      new Func<Stream<Character>, LazyString>() {
