...
public abstract class Stream<A> implements Iterable<A> {
   ...
   */
  public final <B> B stream(final B nil, final Func<A, Func<P1<Stream<A>>, B>> cons) {
   ...
   */
  public final <B> B foldRight(final Func<A, Func<P1<B>, B>> f, final B b) {
   ...
   * @return The final result after the right-fold reduction.
   */
  public final <B> B foldRight(final Func2<A, P1<B>, B> f, final B b) {
   ...
   * @return The final result after the right-fold reduction.
   */
  public final <B> B foldRight1(final Func<A, Func<B, B>> f, final B b) {
   ...
   * @return The final result after the right-fold reduction.
   */
  public final <B> B foldRight1(final Func2<A, B, B> f, final B b) {
   ...
   */
  public final <B> B foldLeft(final Func<B, Func<A, B>> f, final B b) {
    B x = b;
   ...
   * @return The final result after the left-fold reduction.
   */
  public final <B> B foldLeft(final Func2<B, A, B> f, final B b) {
   ...
   * @return The final result after the left-fold reduction.
   */
  public final A foldLeft1(final Func2<A, A, A> f) {
   ...
   * @return The final result after the left-fold reduction.
   */
  public final A foldLeft1(final Func<A, Func<A, A>> f) {
    if (isEmpty())
   ...
   */
  public final <B> Stream<B> map(final Func<A, B> f) {
   ...
   */
  public static <A, B> Func<Func<A, B>, Func<Stream<A>, Stream<B>>> map_() {
    return new Func<Func<A, B>, Func<Stream<A>, Stream<B>>>() {
      public Func<Stream<A>, Stream<B>> f(final Func<A, B> f) {
   ...
   */
  public final Stream<A> filter(final Func<A, Boolean> f) {
   ...
   */
  public final Stream<A> removeAll(final Func<A, Boolean> f) {
   ...
   */
  public static <A, B> Func<B, Stream<A>> sequence_(final Stream<Func<B, A>> fs) {
    return fs.foldRight(new Func2<Func<B, A>, P1<Func<B, Stream<A>>>, Func<B, Stream<A>>>() {
      public Func<B, Stream<A>> f(final Func<B, A> baf, final P1<Func<B, Stream<A>>> p1) {
        return Function.bind(baf, p1._1(), Function.curry(new Func2<A, Stream<A>, Stream<A>>() {
   ...
   *         in this list.
   */
  public final <B, C> Func<B, Stream<C>> mapM(final Func<A, Func<B, C>> f) {
   ...
   */
  public final <B> Stream<B> bind(final Func<A, Stream<B>> f) {
    return map(f).foldLeft(new Func2<Stream<B>, Stream<B>, Stream<B>>() {
        @Override
   ...
   * @return A new stream after performing the map, then final join.
   */
  public final <B, C> Stream<C> bind(final Stream<B> sb, final Func<A, Func<B, C>> f) {
   ...
   * @return A new stream after performing the map, then final join.
   */
  public final <B, C> Stream<C> bind(final Stream<B> sb, final Func2<A, B, C> f) {
   ...
   * @return A new stream after performing the map, then final join.
   */
  public final <B, C, D> Stream<D> bind(final Stream<B> sb, final Stream<C> sc, final Func<A, Func<B, Func<C, D>>> f) {
  ...
  public final <B, C, D, E, F$> Stream<F$> bind(final Stream<B> sb, final Stream<C> sc, final Stream<D> sd,
                                          final Stream<E> se, final Func<A, Func<B, Func<C, Func<D, Func<E, F$>>>>> f) {
  ...
  public final <B> Stream<B> sequence(final Stream<B> bs) {
    final Func<A, Stream<B>> c = constant(bs);
    return bind(c);
  }
   ...
   */
  public final <B> Stream<B> apply(final Stream<Func<A, B>> sf) {
    return sf.bind(new Func<Func<A, B>, Stream<B>>() {
      public Stream<B> f(final Func<A, B> f) {
  ...
  private Promise<Stream<A>> qs(final Ord<A> o, final Strategy<Unit> s) {
    if (isEmpty())
      ...
      final Func<Boolean, Boolean> id = identity();
      final A x = head();
  ...
  private static <A> Func<Stream<A>, Promise<Stream<A>>> qs_(final Ord<A> o, final Strategy<Unit> s) {
    return new Func<Stream<A>, Promise<Stream<A>>>() {
  ...
  private static <A> Func<Stream<A>, Promise<Stream<A>>> flt(final Ord<A> o,
                                                          final Strategy<Unit> s,
                                                          final A x,
                                                          final Func<Boolean, Boolean> f) {
    final Func<Func<A, Boolean>, Func<Stream<A>, Stream<A>>> filter = filter();
    final Func<A, Boolean> lt = o.isLessThan(x);
  ...
  public static <A> Stream<A> stream(final A... as) {
    return as.length == 0 ? Stream.<A>nil()
                          : unfold(P2.tuple(new Func2<A[], Integer, Option<P2<A, P2<A[], Integer>>>>() {
  ...
  public static <A> Stream<A> forever(final Enumerator<A> e, final A from, final long step) {
    return cons(from, new P1<Stream<A>>() {
      public Stream<A> _1() {
        return e.plus(from, step).map(new Func<A, Stream<A>>() {
   ...
   */
  public static <A> Func<Func<A, Boolean>, Func<Stream<A>, Stream<A>>> filter() {
    return curry(new Func2<Func<A, Boolean>, Stream<A>, Stream<A>>() {
      public Stream<A> f(final Func<A, Boolean> f, final Stream<A> as) {
        return as.filter(f);
      }
    });
  }
   ...
   */
  public final <B> Stream<B> zapp(final Stream<Func<A, B>> fs) {
   ...
   *         stream.
   */
  public final <B, C> Stream<C> zipWith(final Stream<B> bs, final Func<A, Func<B, C>> f) {
   ...
   *         stream.
   */
  public final <B, C> Stream<C> zipWith(final Stream<B> bs, final Func2<A, B, C> f) {
   ...
   */
  public final <B, C> Func<Stream<B>, Stream<C>> zipWith(final Func<A, Func<B, C>> f) {
    return new Func<Stream<B>, Stream<C>>() {
  ...
  public final Stream<P2<A, Integer>> zipIndex() {
    return zipWith(range(0), new Func2<A, Integer, P2<A, Integer>>() {
   ...
   */
  public final Stream<A> takeWhile(final Func<A, Boolean> f) {
    return isEmpty() ?
           this :
           f.f(head()) ?
           cons(head(), new P1<Stream<A>>() {
   ...
   */
  public final Stream<A> dropWhile(final Func<A, Boolean> f) {
    Stream<A> as;
   ...
   *         the given predicate and the second element is the remainder of the stream.
   */
  public final P2<Stream<A>, Stream<A>> span(final Func<A, Boolean> p) {
    if (isEmpty())
      return p(this, this);
    else if (p.f(head())) {
   ...
   */
  public final Stream<A> replace(final Func<A, Boolean> p, final A a) {
    if (isEmpty())
      return nil();
    else {
   ...
   *         the given predicate and the second element is the remainder of the stream.
   */
  public final P2<Stream<A>, Stream<A>> split(final Func<A, Boolean> p) {
  ...
  public final Stream<A> reverse() {
    return foldLeft(new Func<Stream<A>, Func<A, Stream<A>>>() {
      public Func<A, Stream<A>> f(final Stream<A> as) {
        return new Func<A, Stream<A>>() {
          public Stream<A> f(final A a) {
   ...
   *         elements match.
   */
  public final Option<A> find(final Func<A, Boolean> f) {
   ...
   */
  public final <B> Stream<B> cobind(final Func<Stream<A>, B> k) {
  ...
  public final Stream<Stream<A>> substreams() {
    return tails().bind(new Func<Stream<A>, Stream<Stream<A>>>() {
   ...
   */
  public final Option<Integer> indexOf(final Func<A, Boolean> p) {
    return zipIndex().find(new Func<P2<A, Integer>, Boolean>() {
   ...
   */
  public final <B> Stream<B> sequenceW(final Stream<Func<Stream<A>, B>> fs) {
    return fs.isEmpty()
           ? Stream.<B>nil()
   ...
   */
  public final Func<Integer, A> toFunction() {
   ...
   */
  public static <A> Stream<A> fromFunction(final Func<Natural, A> f) {
   ...
   */
  public static <A, B> Stream<A> fromFunction(final Enumerator<B> e, final Func<B, A> f, final B i) {
  ...
  public static <A, B> P2<Stream<A>, Stream<B>> unzip(final Stream<P2<A, B>> xs) {
    return xs.foldRight(new Func2<P2<A, B>, P1<P2<Stream<A>, Stream<B>>>, P2<Stream<A>, Stream<B>>>() {
   ...
   */
  public static <A, B, C> Func<Stream<A>, Func<Stream<B>, Func<Func<A, Func<B, C>>, Stream<C>>>> zipWith() {
    return curry(new Func3<Stream<A>, Stream<B>, Func<A, Func<B, C>>, Stream<C>>() {
      public Stream<C> f(final Stream<A> as, final Stream<B> bs, final Func<A, Func<B, C>> f) {
   ...
   */
  public static <A> Func<A, Func<P1<Stream<A>>, Stream<A>>> cons() {
    return new Func<A, Func<P1<Stream<A>>, Stream<A>>>() {
      public Func<P1<Stream<A>>, Stream<A>> f(final A a) {
        return new Func<P1<Stream<A>>, Stream<A>>() {
   ...
   * @return A function that prepends (cons) an element to a stream to produce a new stream.
   */
  public static <A> Func<A, Func<Stream<A>, Stream<A>>> cons_() {
    return curry(new Func2<A, Stream<A>, Stream<A>>() {
   ...
   */
  public static <A> Func<Stream<A>, Boolean> isEmpty_() {
    return new Func<Stream<A>, Boolean>() {
   ...
   */
  public static <A> Func<Stream<A>, Boolean> isNotEmpty_() {
    return new Func<Stream<A>, Boolean>() {
      public Boolean f(final Stream<A> as) {
   ...
   */
  public static <A> Func<A, Stream<A>> single() {
    return new Func<A, Stream<A>>() {
      public Stream<A> f(final A a) {
        return single(a);
      }
   ...
   */
  public static <A> Func<Stream<Stream<A>>, Stream<A>> join() {
    return new Func<Stream<Stream<A>>, Stream<A>>() {
   ...
   *         value.
   */
  public static <A, B> Stream<A> unfold(final Func<B, Option<P2<A, B>>> f, final B b) {
   ...
   *         the second item by applying the function on the previous result and so on.
   */
  public static <A> Stream<A> iterateWhile(final Func<A, A> f, final Func<A, Boolean> p, final A a) {
    return unfold(
        new Func<A, Option<P2<A, A>>>() {
          public Option<P2<A, A>> f(final A o) {
            return Option.iif(new Func<P2<A, A>, Boolean>() {
   ...
   */
  public static <A> Stream<A> iterate(final Func<A, A> f, final A a) {
    return cons(a, new P1<Stream<A>>() {
      public Stream<A> _1() {
   ...
   */
  public static <A> Func<Func<A, A>, Func<A, Stream<A>>> iterate() {
    return curry(new Func2<Func<A, A>, A, Stream<A>>() {
      public Stream<A> f(final Func<A, A> f, final A a) {
        return iterate(f, a);
      }
    });
  }
   ...
   */
  public static <A, B> Func<Func<A, Stream<B>>, Func<Stream<A>, Stream<B>>> bind_() {
    return curry(new Func2<Func<A, Stream<B>>, Stream<A>, Stream<B>>() {
      public Stream<B> f(final Func<A, Stream<B>> f, final Stream<A> as) {
        return as.bind(f);
      }
    });
  }
   ...
   */
  public static <A, B> Func<Func<A, Func<P1<B>, B>>, Func<B, Func<Stream<A>, B>>> foldRight() {
    return curry(new Func3<Func<A, Func<P1<B>, B>>, B, Stream<A>, B>() {
      public B f(final Func<A, Func<P1<B>, B>> f, final B b, final Stream<A> as) {
