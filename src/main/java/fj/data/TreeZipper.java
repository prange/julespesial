...
public final class TreeZipper<A> implements Iterable<TreeZipper<A>> {
   ...
   */
  public static <A>
  Func<Tree<A>, Func<Stream<Tree<A>>, Func<Stream<Tree<A>>, Func<Stream<P3<Stream<Tree<A>>, A, Stream<Tree<A>>>>, TreeZipper<A>>>>>
  treeZipper() {
    return curry(
        new Func4<Tree<A>, Stream<Tree<A>>, Stream<Tree<A>>, Stream<P3<Stream<Tree<A>>, A, Stream<Tree<A>>>>, TreeZipper<A>>() {
   ...
   */
  public static <A>
  Func<TreeZipper<A>, P4<Tree<A>, Stream<Tree<A>>, Stream<Tree<A>>, Stream<P3<Stream<Tree<A>>, A, Stream<Tree<A>>>>>> p_() {
    return new Func<
            TreeZipper<A>,
            P4<Tree<A>,
                Stream<Tree<A>>,
   ...
   */
  public static <A> Func<TreeZipper<A>, TreeZipper<A>> root_() {
    return new Func<TreeZipper<A>, TreeZipper<A>>() {
   ...
   */
  public Option<TreeZipper<A>> findChild(final Func<Tree<A>, Boolean> p) {
    Option<TreeZipper<A>> r = none();

    final Func2<Stream<Tree<A>>, Stream<Tree<A>>, Option<P3<Stream<Tree<A>>, Tree<A>, Stream<Tree<A>>>>> split =
        new Func2<Stream<Tree<A>>, Stream<Tree<A>>, Option<P3<Stream<Tree<A>>, Tree<A>, Stream<Tree<A>>>>>() {
   ...
   */
  public TreeZipper<A> modifyTree(final Func<Tree<A>, Tree<A>> f) {
   ...
   */
  public TreeZipper<A> modifyLabel(final Func<A, A> f) {
  ...
  public TreeZipper<A> setLabel(final A v) {
    return modifyTree(new Func<Tree<A>, Tree<A>>() {
  ...
  public Option<TreeZipper<A>> delete() {
    ...
    if (rights.isNotEmpty())
      ...
      r = some(treeZipper(lefts.head(), lefts.tail()._1(), rights, parents));
        ...
        r = some(loc.modifyTree(new Func<Tree<A>, Tree<A>>() {
          public Tree<A> f(final Tree<A> t) {
  ...
  public TreeZipper<P2<A, Boolean>> zipWithFocus() {
    final Func<A, P2<A, Boolean>> f = flip(P.<A, Boolean>p2()).f(false);
   ...
   */
  public <B> TreeZipper<B> map(final Func<A, B> f) {
    final Func<Tree<A>, Tree<B>> g = Tree.<A, B>fmap_().f(f);
    final Func<Stream<Tree<A>>, Stream<Tree<B>>> h = Stream.<Tree<A>, Tree<B>>map_().f(g);
    return treeZipper(tree.fmap(f), lefts.map(g), rights.map(g), parents.map(
        new Func<P3<Stream<Tree<A>>, A, Stream<Tree<A>>>, P3<Stream<Tree<B>>, B, Stream<Tree<B>>>>() {
   ...
   */
  public static <A> Func<Tree<A>, TreeZipper<A>> fromTree() {
    return new Func<Tree<A>, TreeZipper<A>>() {
   ...
   */
  public static <A> Func<TreeZipper<A>, Option<TreeZipper<A>>> left_() {
    return new Func<TreeZipper<A>, Option<TreeZipper<A>>>() {
   ...
   */
  public static <A> Func<TreeZipper<A>, Option<TreeZipper<A>>> right_() {
    return new Func<TreeZipper<A>, Option<TreeZipper<A>>>() {
      public Option<TreeZipper<A>> f(final TreeZipper<A> z) {
        return z.right();
      }
  ...
  private Stream<Tree<TreeZipper<A>>> uf(final Func<TreeZipper<A>, Option<TreeZipper<A>>> f) {
    return unfold(
        new Func<Option<TreeZipper<A>>, Option<P2<Tree<TreeZipper<A>>, Option<TreeZipper<A>>>>>() {
  ...
  private static <A> Func<TreeZipper<A>, P2<TreeZipper<A>, P1<Stream<TreeZipper<A>>>>> dwn() {
    return new Func<TreeZipper<A>, P2<TreeZipper<A>, P1<Stream<TreeZipper<A>>>>>() {
      public P2<TreeZipper<A>, P1<Stream<TreeZipper<A>>>> f(final TreeZipper<A> tz) {
        return P.<TreeZipper<A>, P1<Stream<TreeZipper<A>>>>p(tz, new P1<Stream<TreeZipper<A>>>() {
          private Func<Option<TreeZipper<A>>, Option<P2<TreeZipper<A>, Option<TreeZipper<A>>>>> fwd() {
            return new Func<Option<TreeZipper<A>>, Option<P2<TreeZipper<A>, Option<TreeZipper<A>>>>>() {
   ...
   */
  public <B> TreeZipper<B> cobind(final Func<TreeZipper<A>, B> f) {
   ...
   */
  public static <A> Func2<Func<Tree<A>, Boolean>, TreeZipper<A>, Option<TreeZipper<A>>> findChild() {
    return new Func2<Func<Tree<A>, Boolean>, TreeZipper<A>, Option<TreeZipper<A>>>() {
      public Option<TreeZipper<A>> f(final Func<Tree<A>, Boolean> f, final TreeZipper<A> az) {
   ...
   */
  public <B, C> TreeZipper<C> zipWith(final TreeZipper<B> bs, final Func2<A, B, C> f) {
   ...
   * @return The result of applying the given function over this TreeZipper and the given TreeZipper, location-wise.
   */
  public <B, C> TreeZipper<C> zipWith(final TreeZipper<B> bs, final Func<A, Func<B, C>> f) {
