...
public final class Measured<V, A> {
  ...
  private Measured(final Monoid<V> m, final Func<A, V> measure) {
    this.m = m;
    this.measure = measure;
  }

  public static <V, A> Measured<V, A> measured(final Monoid<V> m, final Func<A, V> measure) {
  ...
  public Measured<V, Node<V, A>> nodeMeasured() {
    return new Measured<V, Node<V, A>>(m, new Func<Node<V, A>, V>() {
  ...
  public Measured<V, Digit<V, A>> digitMeasured() {
    return new Measured<V, Digit<V, A>>(m, new Func<Digit<V, A>, V>() {
