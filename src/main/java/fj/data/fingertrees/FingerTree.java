...
public abstract class FingerTree<V, A> {
   ...
   * @return A reduction of this tree by applying the given function, associating to the right.
   */
  public abstract A reduceRight(final Func<A, Func<A, A>> f);
   ...
   * @return A reduction of this tree by applying the given function, associating to the right.
   */
  public abstract A reduceLeft(final Func<A, Func<A, A>> f);
   ...
   */
  public abstract <B> B match(final Func<Empty<V, A>, B> empty, final Func<Single<V, A>, B> single,
   ...
   */
  public static <V, A> Measured<V, A> measured(final Monoid<V> monoid, final Func<A, V> measure) {
