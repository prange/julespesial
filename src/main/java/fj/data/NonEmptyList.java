...
public final class NonEmptyList<A> implements Iterable<A> {
   ...
   */
  public <B> NonEmptyList<B> map(final Func<A, B> f) {
   ...
   */
  public <B> NonEmptyList<B> bind(final Func<A, NonEmptyList<B>> f) {
  ...
  public NonEmptyList<NonEmptyList<A>> sublists() {
    return fromList(
        somes(toList().toStream().substreams()
            .map(new Func<List<A>, Option<NonEmptyList<A>>>() {
  ...
  public NonEmptyList<NonEmptyList<A>> tails() {
    return fromList(somes(toList().tails().map(new Func<List<A>, Option<NonEmptyList<A>>>() {
      public Option<NonEmptyList<A>> f(final List<A> list) {
        return fromList(list);
      }
    }))).some();
   ...
   */
  public <B> NonEmptyList<B> mapTails(final Func<NonEmptyList<A>, B> f) {
    return tails().map(f);
  }
   ...
   */
  public static <A> Func<NonEmptyList<A>, List<A>> toList_() {
    return new Func<NonEmptyList<A>, List<A>>() {
   ...
   */
  public static <A> Func<A, NonEmptyList<A>> nel() {
    return new Func<A, NonEmptyList<A>>() {
