...
public final class V5<A> implements Iterable<A> {
   ...
   */
  public <B> V5<B> map(final Func<A, B> f) {
   ...
   */
  public <B> V5<B> apply(final V5<Func<A, B>> vf) {
   ...
   */
  public <B, C> V5<C> zipWith(final Func<A, Func<B, C>> f, final V5<B> bs) {
   ...
   */
  public static <A> Func<V5<A>, Stream<A>> toStream_() {
    return new Func<V5<A>, Stream<A>>() {
   ...
   */
  public static <A> Func<V5<A>, P5<A, A, A, A, A>> p_() {
    return new Func<V5<A>, P5<A, A, A, A, A>>() {
   ...
   */
  public static <A> Func<V5<A>, A> __1() {
    return new Func<V5<A>, A>() {
   ...
   */
  public static <A> Func<V5<A>, A> __2() {
    return new Func<V5<A>, A>() {
      public A f(final V5<A> v) {
        return v._2();
      }
   ...
   */
  public static <A> Func<V5<A>, A> __3() {
    return new Func<V5<A>, A>() {
      public A f(final V5<A> v) {
        return v._3();
      }
   ...
   */
  public static <A> Func<V5<A>, A> __4() {
    return new Func<V5<A>, A>() {
      public A f(final V5<A> v) {
        return v._4();
      }
   ...
   */
  public static <A> Func<V5<A>, A> __5() {
    return new Func<V5<A>, A>() {
      public A f(final V5<A> v) {
        return v._5();
      }
