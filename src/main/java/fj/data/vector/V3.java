...
public final class V3<A> implements Iterable<A> {
   ...
   */
  public <B> V3<B> apply(final V3<Func<A, B>> vf) {
   ...
   */
  public <B, C> V3<C> zipWith(final Func<A, Func<B, C>> f, final V3<B> bs) {
   ...
   */
  public <B> V3<B> map(final Func<A, B> f) {
   ...
   */
  public static <A> Func<V3<A>, Stream<A>> toStream_() {
    return new Func<V3<A>, Stream<A>>() {
   ...
   */
  public static <A> Func<V3<A>, P3<A, A, A>> p_() {
    return new Func<V3<A>, P3<A, A, A>>() {
   ...
   */
  public static <A> Func<V3<A>, A> __1() {
    return new Func<V3<A>, A>() {
   ...
   */
  public static <A> Func<V3<A>, A> __2() {
    return new Func<V3<A>, A>() {
      public A f(final V3<A> v) {
        return v._2();
      }
   ...
   */
  public static <A> Func<V3<A>, A> __3() {
    return new Func<V3<A>, A>() {
      public A f(final V3<A> v) {
        return v._3();
      }
