...
public final class V4<A> implements Iterable<A> {
   ...
   */
  public <B> V4<B> map(final Func<A, B> f) {
   ...
   */
  public <B> V4<B> apply(final V4<Func<A, B>> vf) {
   ...
   */
  public <B, C> V4<C> zipWith(final Func<A, Func<B, C>> f, final V4<B> bs) {
   ...
   */
  public static <A> Func<V4<A>, Stream<A>> toStream_() {
    return new Func<V4<A>, Stream<A>>() {
   ...
   */
  public static <A> Func<V4<A>, P4<A, A, A, A>> p_() {
    return new Func<V4<A>, P4<A, A, A, A>>() {
   ...
   */
  public static <A> Func<V4<A>, A> __1() {
    return new Func<V4<A>, A>() {
   ...
   */
  public static <A> Func<V4<A>, A> __2() {
    return new Func<V4<A>, A>() {
      public A f(final V4<A> v) {
        return v._2();
      }
   ...
   */
  public static <A> Func<V4<A>, A> __3() {
    return new Func<V4<A>, A>() {
      public A f(final V4<A> v) {
        return v._3();
      }
   ...
   */
  public static <A> Func<V4<A>, A> __4() {
    return new Func<V4<A>, A>() {
      public A f(final V4<A> v) {
        return v._4();
      }
