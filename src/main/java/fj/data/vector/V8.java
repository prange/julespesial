...
public final class V8<A> implements Iterable<A> {
   ...
   */
  public <B> V8<B> map(final Func<A, B> f) {
   ...
   */
  public <B> V8<B> apply(final V8<Func<A, B>> vf) {
   ...
   */
  public <B, C> V8<C> zipWith(final Func<A, Func<B, C>> f, final V8<B> bs) {
   ...
   */
  public static <A> Func<V8<A>, Stream<A>> toStream_() {
    return new Func<V8<A>, Stream<A>>() {
   ...
   */
  public static <A> Func<V8<A>, P8<A, A, A, A, A, A, A, A>> p_() {
    return new Func<V8<A>, P8<A, A, A, A, A, A, A, A>>() {
   ...
   */
  public static <A> Func<V8<A>, A> __1() {
    return new Func<V8<A>, A>() {
   ...
   */
  public static <A> Func<V8<A>, A> __2() {
    return new Func<V8<A>, A>() {
      public A f(final V8<A> v) {
        return v._2();
      }
   ...
   */
  public static <A> Func<V8<A>, A> __3() {
    return new Func<V8<A>, A>() {
      public A f(final V8<A> v) {
        return v._3();
      }
   ...
   */
  public static <A> Func<V8<A>, A> __4() {
    return new Func<V8<A>, A>() {
      public A f(final V8<A> v) {
        return v._4();
      }
   ...
   */
  public static <A> Func<V8<A>, A> __5() {
    return new Func<V8<A>, A>() {
      public A f(final V8<A> v) {
        return v._5();
      }
   ...
   */
  public static <A> Func<V8<A>, A> __6() {
    return new Func<V8<A>, A>() {
      public A f(final V8<A> v) {
        return v._6();
      }
   ...
   */
  public static <A> Func<V8<A>, A> __7() {
    return new Func<V8<A>, A>() {
      public A f(final V8<A> v) {
        return v._7();
      }
   ...
   */
  public static <A> Func<V8<A>, A> __8() {
    return new Func<V8<A>, A>() {
      public A f(final V8<A> v) {
        return v._8();
      }
