...
public final class V7<A> implements Iterable<A> {
   ...
   */
  public <B> V7<B> map(final Func<A, B> f) {
   ...
   */
  public <B> V7<B> apply(final V7<Func<A, B>> vf) {
   ...
   */
  public <B, C> V7<C> zipWith(final Func<A, Func<B, C>> f, final V7<B> bs) {
   ...
   */
  public static <A> Func<V7<A>, Stream<A>> toStream_() {
    return new Func<V7<A>, Stream<A>>() {
   ...
   */
  public static <A> Func<V7<A>, P7<A, A, A, A, A, A, A>> p_() {
    return new Func<V7<A>, P7<A, A, A, A, A, A, A>>() {
   ...
   */
  public static <A> Func<V7<A>, A> __1() {
    return new Func<V7<A>, A>() {
   ...
   */
  public static <A> Func<V7<A>, A> __2() {
    return new Func<V7<A>, A>() {
      public A f(final V7<A> v) {
        return v._2();
      }
   ...
   */
  public static <A> Func<V7<A>, A> __3() {
    return new Func<V7<A>, A>() {
      public A f(final V7<A> v) {
        return v._3();
      }
   ...
   */
  public static <A> Func<V7<A>, A> __4() {
    return new Func<V7<A>, A>() {
      public A f(final V7<A> v) {
        return v._4();
      }
   ...
   */
  public static <A> Func<V7<A>, A> __5() {
    return new Func<V7<A>, A>() {
      public A f(final V7<A> v) {
        return v._5();
      }
   ...
   */
  public static <A> Func<V7<A>, A> __6() {
    return new Func<V7<A>, A>() {
      public A f(final V7<A> v) {
        return v._6();
      }
   ...
   */
  public static <A> Func<V7<A>, A> __7() {
    return new Func<V7<A>, A>() {
      public A f(final V7<A> v) {
        return v._7();
      }
