...
public final class V2<A> implements Iterable<A> {
   ...
   */
  public static <A> Func<V2<A>, A> __1() {
    return new Func<V2<A>, A>() {
   ...
   */
  public static <A> Func<V2<A>, A> __2() {
    return new Func<V2<A>, A>() {
      public A f(final V2<A> v) {
        return v._2();
      }
   ...
   */
  public static <A> Func<V2<A>, Stream<A>> toStream_() {
    return new Func<V2<A>, Stream<A>>() {
   ...
   */
  public static <A> Func<V2<A>, P2<A, A>> p_() {
    return new Func<V2<A>, P2<A, A>>() {
   ...
   */
  public <B> V2<B> map(final Func<A, B> f) {
   ...
   */
  public <B> V2<B> apply(final V2<Func<A, B>> vf) {
   ...
   */
  public <B, C> V2<C> zipWith(final Func<A, Func<B, C>> f, final V2<B> bs) {
