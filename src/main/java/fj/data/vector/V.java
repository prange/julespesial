...
public final class V {
   ...
   */
  public static <A> Func2<A, A, V2<A>> v2() {
    return new Func2<A, A, V2<A>>() {
   ...
   */
  public static <A> Func3<A, A, A, V3<A>> v3() {
    return new Func3<A, A, A, V3<A>>() {
   ...
   */
  public static <A> Func4<A, A, A, A, V4<A>> v4() {
    return new Func4<A, A, A, A, V4<A>>() {
   ...
   */
  public static <A> Func5<A, A, A, A, A, V5<A>> v5() {
    return new Func5<A, A, A, A, A, V5<A>>() {
