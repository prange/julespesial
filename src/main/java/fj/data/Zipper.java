...
public final class Zipper<A> implements Iterable<Zipper<A>> {
   ...
   */
  public static <A> Func3<Stream<A>, A, Stream<A>, Zipper<A>> zipper() {
    return new Func3<Stream<A>, A, Stream<A>, Zipper<A>>() {
   ...
   */
  public static <A> Func<Zipper<A>, P3<Stream<A>, A, Stream<A>>> p_() {
    return new Func<Zipper<A>, P3<Stream<A>, A, Stream<A>>>() {
   ...
   */
  public <B> Zipper<B> map(final Func<A, B> f) {
   ...
   */
  public <B> B foldRight(final Func<A, Func<B, B>> f, final B z) {
   ...
   */
  public static <A> Func<Zipper<A>, Option<Zipper<A>>> next_() {
    return new Func<Zipper<A>, Option<Zipper<A>>>() {
   ...
   */
  public static <A> Func<Zipper<A>, Option<Zipper<A>>> previous_() {
    return new Func<Zipper<A>, Option<Zipper<A>>>() {
      public Option<Zipper<A>> f(final Zipper<A> as) {
        return as.previous();
      }
   ...
   */
  public int length() {
    return foldRight(Function.<A, Func<Integer, Integer>>constant(Integers.add.f(1)), 0);
  }
  ...
  public Zipper<Zipper<A>> positions() {
    final Stream<Zipper<A>> left = Stream.unfold(
        new Func<Zipper<A>, Option<P2<Zipper<A>, Zipper<A>>>>() {
   ...
   */
  public <B> Zipper<B> cobind(final Func<Zipper<A>, B> f) {
   ...
   */
  public static <A> Func<Integer, Func<Zipper<A>, Option<Zipper<A>>>> move() {
    return curry(new Func2<Integer, Zipper<A>, Option<Zipper<A>>>() {
   ...
   */
  public Option<Zipper<A>> find(final Func<A, Boolean> p) {
    if (p.f(focus()))
      return some(this);
    else {
      final Zipper<Zipper<A>> ps = positions();
      return ps.lefts().interleave(ps.rights()).find(new Func<Zipper<A>, Boolean>() {
   ...
   */
  public <B, C> Zipper<C> zipWith(final Zipper<B> bs, final Func2<A, B, C> f) {
   ...
   * @return The result of applying the given function over this Zipper and the given Zipper, location-wise.
   */
  public <B, C> Zipper<C> zipWith(final Zipper<B> bs, final Func<A, Func<B, C>> f) {
