...
public final class IterableW<A> implements Iterable<A> {
   ...
   */
  public static <A, T extends Iterable<A>> Func<T, IterableW<A>> wrap() {
    return new Func<T, IterableW<A>>() {
   ...
   */
  public static <A, B> Func<A, IterableW<B>> iterable(final Func<A, B> f) {
    return new Func<A, IterableW<B>>() {
   ...
   */
  public static <A, B> Func<Func<A, B>, Func<A, IterableW<B>>> arrow() {
    return new Func<Func<A, B>, Func<A, IterableW<B>>>() {
      public Func<A, IterableW<B>> f(final Func<A, B> f) {
        return iterable(f);
      }
    };
  }
   ...
   */
  public <B, T extends Iterable<B>> IterableW<B> bind(final Func<A, T> f) {
    return wrap(iterableStream(this).bind(new Func<A, Stream<B>>() {
   ...
   */
  public <B> IterableW<B> apply(final Iterable<Func<A, B>> f) {
    return wrap(f).bind(new Func<Func<A, B>, Iterable<B>>() {
      public Iterable<B> f(final Func<A, B> f) {
        return map(f);
      }
    });
  }
   ...
   */
  public static <A, B, C> IterableW<C> bind(final Iterable<A> a, final Iterable<B> b, final Func<A, Func<B, C>> f) {
   ...
   */
  public static <A, B, C> Func<Iterable<A>, Func<Iterable<B>, IterableW<C>>> liftM2(final Func<A, Func<B, C>> f) {
    return curry(new Func2<Iterable<A>, Iterable<B>, IterableW<C>>() {
  ...
  public static <A, T extends Iterable<A>> IterableW<IterableW<A>> sequence(final Iterable<T> as) {
    ...
    return ts.isEmpty() ? iterable(wrap(Option.<A>none())) : wrap(ts.head()).bind(new Func<A, Iterable<IterableW<A>>>() {
      public Iterable<IterableW<A>> f(final A a) {
        return sequence(ts.tail().map(IterableW.<T, Stream<T>>wrap())._1())
            .bind(new Func<IterableW<A>, Iterable<IterableW<A>>>() {
   ...
   */
  public static <A, B, T extends Iterable<B>> Func<IterableW<A>, Func<Func<A, T>, IterableW<B>>> bind() {
    return new Func<IterableW<A>, Func<Func<A, T>, IterableW<B>>>() {
      public Func<Func<A, T>, IterableW<B>> f(final IterableW<A> a) {
        return new Func<Func<A, T>, IterableW<B>>() {
          public IterableW<B> f(final Func<A, T> f) {
            return a.bind(f);
          }
        };
      }
   ...
   */
  public static <A, T extends Iterable<A>> Func<Iterable<T>, IterableW<A>> join() {
    return new Func<Iterable<T>, IterableW<A>>() {
   ...
   */
  public <B> IterableW<B> map(final Func<A, B> f) {
   ...
   */
  public static <A, B> Func<Func<A, B>, Func<IterableW<A>, IterableW<B>>> map() {
    return new Func<Func<A, B>, Func<IterableW<A>, IterableW<B>>>() {
      public Func<IterableW<A>, IterableW<B>> f(final Func<A, B> f) {
        return new Func<IterableW<A>, IterableW<B>>() {
   ...
   */
  public <B> B foldLeft(final Func<B, Func<A, B>> f, final B z) {
    B p = z;
    for (final A x : this) {
      p = f.f(p).f(x);
    }
   ...
   */
  public A foldLeft1(final Func2<A, A, A> f) {
   ...
   * @return The final result after the left-fold reduction.
   */
  public A foldLeft1(final Func<A, Func<A, A>> f) {
   ...
   * @return The result of the catamorphism.
   */
  public <B> B foldRight(final Func2<A, B, B> f, final B z) {
    final Func<B, B> id = identity();
    return foldLeft(curry(new Func3<Func<B, B>, A, B, B>() {
      public B f(final Func<B, B> k, final A a, final B b) {
        return k.f(f.f(a, b));
      }
    }), id).f(z);
  }
   ...
   */
  public <B> IterableW<B> zapp(final Iterable<Func<A, B>> fs) {
   ...
   *         iterable.
   */
  public <B, C> Iterable<C> zipWith(final Iterable<B> bs, final Func<A, Func<B, C>> f) {
   ...
   *         iterable.
   */
  public <B, C> Iterable<C> zipWith(final Iterable<B> bs, final Func2<A, B, C> f) {
