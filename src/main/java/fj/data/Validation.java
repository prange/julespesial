...
public final class Validation<E, T> implements Iterable<T> {
   ...
   */
  public <X> X validation(final Func<E, X> fail, final Func<T, X> success) {
   ...
   */
  public Unit foreach(final Func<T, Unit> f) {
  ...
  public <A> Validation<E, A> map(final Func<T, A> f) {
    return isFail() ?
   ...
   */
  @SuppressWarnings({"unchecked"})
  public <A> Validation<E, A> bind(final Func<T, Validation<E, A>> f) {
   ...
   *         success value, otherwise, returns a success in <code>Some</code>.
   */
  public <A> Option<Validation<A, T>> filter(final Func<T, Boolean> f) {
   ...
   */
  public <A> Validation<E, A> apply(final Validation<E, Func<T, A>> v) {
    return v.bind(new Func<Func<T, A>, Validation<E, A>>() {
      public Validation<E, A> f(final Func<T, A> f) {
        return map(f);
      }
    });
  }
   ...
   *         function to the success value.
   */
  public boolean forall(final Func<T, Boolean> f) {
   ...
   *         function to the success value.
   */
  public boolean exists(final Func<T, Boolean> f) {
   ...
   */
  @SuppressWarnings({"unchecked"})
  public <A> Validation<E, A> accumapply(final Semigroup<E> s, final Validation<E, Func<T, A>> v) {
    return isFail() ?
   ...
   *         one or more failed.
   */
  public <A, B> Validation<E, B> accumulate(final Semigroup<E> s, final Validation<E, A> va, final Func<T, Func<A, B>> f) {
   ...
   *         one or more failed.
   */
  public <A, B> Validation<E, B> accumulate(final Semigroup<E> s, final Validation<E, A> va, final Func2<T, A, B> f) {
  ...
  public <A> Option<E> accumulate(final Semigroup<E> s, final Validation<E, A> va) {
    return accumulate(s, va, new Func2<T, A, Unit>() {
  ...
  public <A, B, C> Validation<E, C> accumulate(final Semigroup<E> s, final Validation<E, A> va,
                                               final Validation<E, B> vb, final Func<T, Func<A, Func<B, C>>> f) {
   ...
   */
  public <A, B, C> Validation<E, C> accumulate(final Semigroup<E> s, final Validation<E, A> va,
                                               final Validation<E, B> vb, final Func3<T, A, B, C> f) {
  ...
  public <A, B> Option<E> accumulate(final Semigroup<E> s, final Validation<E, A> va, final Validation<E, B> vb) {
    return accumulate(s, va, vb, new Func3<T, A, B, Unit>() {
  ...
  public <A, B, C, D> Validation<E, D> accumulate(final Semigroup<E> s, final Validation<E, A> va,
                                                  ...
                                                  final Func<T, Func<A, Func<B, Func<C, D>>>> f) {
  ...
  public <A, B, C> Option<E> accumulate(final Semigroup<E> s, final Validation<E, A> va, final Validation<E, B> vb,
    ...
    return accumulate(s, va, vb, vc, new Func4<T, A, B, C, Unit>() {
  ...
  public <A, B, C, D, E$> Validation<E, E$> accumulate(final Semigroup<E> s, final Validation<E, A> va,
                                                       ...
                                                       final Func<T, Func<A, Func<B, Func<C, Func<D, E$>>>>> f) {
  ...
  public <A, B, C, D, E$> Validation<E, E$> accumulate(final Semigroup<E> s, final Validation<E, A> va,
                                                       final Validation<E, B> vb, final Validation<E, C> vc,
                                                       final Validation<E, D> vd, final Func5<T, A, B, C, D, E$> f) {
  ...
  public <A, B, C, D> Option<E> accumulate(final Semigroup<E> s, final Validation<E, A> va, final Validation<E, B> vb,
    ...
    return accumulate(s, va, vb, vc, vd, new Func5<T, A, B, C, D, Unit>() {
  ...
  public <A, B, C, D, E$, F$> Validation<E, F$> accumulate(final Semigroup<E> s, final Validation<E, A> va,
                                                           ...
                                                           final Func<T, Func<A, Func<B, Func<C, Func<D, Func<E$, F$>>>>>> f) {
  ...
  public <A, B, C, D, E$> Option<E> accumulate(final Semigroup<E> s, final Validation<E, A> va,
                                               final Validation<E, B> vb, final Validation<E, C> vc,
                                               final Validation<E, D> vd, final Validation<E, E$> ve) {
    return accumulate(s, va, vb, vc, vd, ve, new Func6<T, A, B, C, D, E$, Unit>() {
  ...
  public <A, B, C, D, E$, F$, G> Validation<E, G> accumulate(final Semigroup<E> s, final Validation<E, A> va,
                                                             ...
                                                             final Func<T, Func<A, Func<B, Func<C, Func<D, Func<E$, Func<F$, G>>>>>>> f) {
  ...
  public <A, B, C, D, E$, F$> Option<E> accumulate(final Semigroup<E> s, final Validation<E, A> va,
                                                   ...
                                                   final Validation<E, D> vd, final Validation<E, E$> ve,
                                                   final Validation<E, F$> vf) {
    return accumulate(s, va, vb, vc, vd, ve, vf, new Func7<T, A, B, C, D, E$, F$, Unit>() {
  ...
  public <A, B, C, D, E$, F$, G, H> Validation<E, H> accumulate(final Semigroup<E> s, final Validation<E, A> va,
                                                                ...
                                                                final Func<T, Func<A, Func<B, Func<C, Func<D, Func<E$, Func<F$, Func<G, H>>>>>>>> f) {
  ...
  public <A, B, C, D, E$, F$, G, H> Validation<E, H> accumulate(final Semigroup<E> s, final Validation<E, A> va,
                                                                ...
                                                                final Validation<E, D> vd, final Validation<E, E$> ve,
                                                                final Validation<E, F$> vf, final Validation<E, G> vg,
                                                                final Func8<T, A, B, C, D, E$, F$, G, H> f) {
  ...
  public <A, B, C, D, E$, F$, G> Option<E> accumulate(final Semigroup<E> s, final Validation<E, A> va,
                                                      ...
                                                      final Validation<E, D> vd, final Validation<E, E$> ve,
                                                      final Validation<E, F$> vf, final Validation<E, G> vg) {
    return accumulate(s, va, vb, vc, vd, ve, vf, vg, new Func8<T, A, B, C, D, E$, F$, G, Unit>() {
  ...
  public final class FailProjection<E, T> implements Iterable<E> {
     ...
     * @return The unit value.
     */
    public Unit foreach(final Func<E, Unit> f) {
     ...
     * @return A new validation with the function mapped.
     */
    public <A> Validation<A, T> map(final Func<E, A> f) {
     ...
     * @return A new validation value after binding.
     */
    public <A> Validation<A, T> bind(final Func<E, Validation<A, T>> f) {
    ...
    public <A> Validation<A, T> sequence(final Validation<A, T> v) {
      return bind(new Func<E, Validation<A, T>>() {
     ...
     *         failing value, otherwise, returns a fail in <code>Some</code>.
     */
    public <A> Option<Validation<E, A>> filter(final Func<E, Boolean> f) {
     ...
     * @return The result of function application in validation.
     */
    public <A> Validation<A, T> apply(final Validation<Func<E, A>, T> v) {
      return v.f().bind(new Func<Func<E, A>, Validation<A, T>>() {
        public Validation<A, T> f(final Func<E, A> f) {
          return map(f);
        }
      });
    }
     ...
     *         function to the failing value.
     */
    public boolean forall(final Func<E, Boolean> f) {
     ...
     *         function to the failing value.
     */
    public boolean exists(final Func<E, Boolean> f) {
   ...
   */
  public static <E, T> Func<Either<E, T>, Validation<E, T>> validation() {
    return new Func<Either<E, T>, Validation<E, T>>() {
   ...
   */
  public static <E, T> Func<Validation<E, T>, Either<E, T>> either() {
    return new Func<Validation<E, T>, Either<E, T>>() {
   ...
   */
  public static final Func<String, Validation<NumberFormatException, Byte>> parseByte = new Func<String, Validation<NumberFormatException, Byte>>() {
   ...
   */
  public static final Func<String, Validation<NumberFormatException, Double>> parseDouble = new Func<String, Validation<NumberFormatException, Double>>() {
   ...
   */
  public static final Func<String, Validation<NumberFormatException, Float>> parseFloat = new Func<String, Validation<NumberFormatException, Float>>() {
   ...
   */
  public static final Func<String, Validation<NumberFormatException, Integer>> parseInt = new Func<String, Validation<NumberFormatException, Integer>>() {
   ...
   */
  public static final Func<String, Validation<NumberFormatException, Long>> parseLong = new Func<String, Validation<NumberFormatException, Long>>() {
   ...
   */
  public static final Func<String, Validation<NumberFormatException, Short>> parseShort = new Func<String, Validation<NumberFormatException, Short>>() {
