...
public final class Tree<A> implements Iterable<A> {
   ...
   */
  public static <A> Func<A, Func<P1<Stream<Tree<A>>>, Tree<A>>> node() {
    return curry(new Func2<A, P1<Stream<Tree<A>>>, Tree<A>>() {
   ...
   */
  public static <A> Func<Tree<A>, A> root_() {
    return new Func<Tree<A>, A>() {
   ...
   */
  public static <A> Func<Tree<A>, P1<Stream<Tree<A>>>> subForest_() {
    return new Func<Tree<A>, P1<Stream<Tree<A>>>>() {
  ...
  public Stream<A> flatten() {
    final Func2<Tree<A>, P1<Stream<A>>, Stream<A>> squish = new Func2<Tree<A>, P1<Stream<A>>, Stream<A>>() {
   ...
   * @return The elements of the tree in pre-order.
   */
  public static <A> Func<Tree<A>, Stream<A>> flatten_() {
    return new Func<Tree<A>, Stream<A>>() {
  ...
  public Stream<Stream<A>> levels() {
    final Func<Stream<Tree<A>>, Stream<Tree<A>>> flatSubForests =
        Stream.<Tree<A>, Tree<A>>bind_().f(compose(P1.<Stream<Tree<A>>>__1(), Tree.<A>subForest_()));
    final Func<Stream<Tree<A>>, Stream<A>> roots = Stream.<Tree<A>, A>map_().f(Tree.<A>root_());
   ...
   */
  public <B> Tree<B> fmap(final Func<A, B> f) {
   ...
   */
  public static <A, B> Func<Func<A, B>, Func<Tree<A>, Tree<B>>> fmap_() {
    return new Func<Func<A, B>, Func<Tree<A>, Tree<B>>>() {
      public Func<Tree<A>, Tree<B>> f(final Func<A, B> f) {
        return new Func<Tree<A>, Tree<B>>() {
   ...
   */
  public <B> B foldMap(final Func<A, B> f, final Monoid<B> m) {
   ...
   */
  public static <A, B> Func<Tree<A>, B> foldMap_(final Func<A, B> f, final Monoid<B> m) {
    return new Func<Tree<A>, B>() {
   ...
   */
  public static <A, B> Func<B, Tree<A>> unfoldTree(final Func<B, P2<A, P1<Stream<B>>>> f) {
    return new Func<B, Tree<A>>() {
   ...
   */
  public <B> Tree<B> cobind(final Func<Tree<A>, B> f) {
    return unfoldTree(new Func<Tree<A>, P2<B, P1<Stream<Tree<A>>>>>() {
  ...
  public Tree<Tree<A>> cojoin() {
    final Func<Tree<A>, Tree<A>> id = identity();
    return cobind(id);
  }
  ...
  public static <A> Show<Tree<A>> show2D(final Show<A> s) {
    return Show.showS(new Func<Tree<A>, String>() {
   ...
   */
  public <B, C> Tree<C> zipWith(final Tree<B> bs, final Func2<A, B, C> f) {
   ...
   * @return A new tree of the results of applying the given function over this tree and the given tree, position-wise.
   */
  public <B, C> Tree<C> zipWith(final Tree<B> bs, final Func<A, Func<B, C>> f) {
   ...
   */
  public static <A, B> Tree<B> bottomUp(Tree<A> t, final Func<P2<A, Stream<B>>, B> f) {
    final Func<Tree<A>, Tree<B>> recursiveCall = new Func<Tree<A>, Tree<B>>() {
	...
	*/
   private static <A> Func<Tree<A>, A> getRoot() {
     return new Func<Tree<A>, A>() {
