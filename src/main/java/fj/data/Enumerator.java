...
public final class Enumerator<A> {
  private final Func<A, Option<A>> successor;
  private final Func<A, Option<A>> predecessor;
  private final Option<A> max;
  private final Option<A> min;
  private final Ord<A> order;
  private final Func<A, Func<Long, Option<A>>> plus;

  private Enumerator(final Func<A, Option<A>> successor, final Func<A, Option<A>> predecessor, final Option<A> max,
                     final Option<A> min, final Ord<A> order, final Func<A, Func<Long, Option<A>>> plus) {
   ...
   */
  public Func<A, Option<A>> successor() {
    return successor;
  }
   ...
   */
  public Func<A, Option<A>> predecessor() {
    return predecessor;
  }
   ...
   */
  public Func<A, Func<Long, Option<A>>> plus() {
    return plus;
  }
   ...
   * @return A function that moves a value along the enumerator a given number of times.
   */
  public Func<Long, Option<A>> plus(final A a) {
    return plus.f(a);
  }
   ...
   * @return A function that moves a value along the enumerator a given number of times.
   */
  public Func<A, Option<A>> plus(final long l) {
   ...
   */
  public <B> Enumerator<B> xmap(final Func<A, B> f, final Func<B, A> g) {
    final Func<Option<A>, Option<B>> of = new Func<Option<A>, Option<B>>() {
   ...
   */
  public static <A> Enumerator<A> enumerator(final Func<A, Option<A>> successor, final Func<A, Option<A>> predecessor,
                                             final Option<A> max, final Option<A> min, final Ord<A> order,
                                             final Func<A, Func<Long, Option<A>>> plus) {
  ...
  public static <A> Enumerator<A> enumerator(final Func<A, Option<A>> successor, final Func<A, Option<A>> predecessor,
                                             final Option<A> max, final Option<A> min, final Ord<A> order) {
    return new Enumerator<A>(successor, predecessor, max, min, order, curry(new Func2<A, Long, Option<A>>() {
   ...
   */
  public static final Enumerator<Boolean> booleanEnumerator = enumerator(new Func<Boolean, Option<Boolean>>() {
    public Option<Boolean> f(final Boolean b) {
      return b ? Option.<Boolean>none() : some(true);
    }
  }, new Func<Boolean, Option<Boolean>>() {
    public Option<Boolean> f(final Boolean b) {
   ...
   */
  public static final Enumerator<Byte> byteEnumerator = enumerator(new Func<Byte, Option<Byte>>() {
    public Option<Byte> f(final Byte b) {
      return b == Byte.MAX_VALUE ? Option.<Byte>none() : some((byte) (b + 1));
    }
  }, new Func<Byte, Option<Byte>>() {
    public Option<Byte> f(final Byte b) {
   ...
   */
  public static final Enumerator<Character> charEnumerator = enumerator(new Func<Character, Option<Character>>() {
    public Option<Character> f(final Character c) {
      return c == Character.MAX_VALUE ? Option.<Character>none() : some((char) (c + 1));
    }
  }, new Func<Character, Option<Character>>() {
    public Option<Character> f(final Character c) {
   ...
   */
  public static final Enumerator<Double> doubleEnumerator = enumerator(new Func<Double, Option<Double>>() {
    public Option<Double> f(final Double d) {
      return d == Double.MAX_VALUE ? Option.<Double>none() : some(d + 1D);
    }
  }, new Func<Double, Option<Double>>() {
    public Option<Double> f(final Double d) {
   ...
   */
  public static final Enumerator<Float> floatEnumerator = enumerator(new Func<Float, Option<Float>>() {
    public Option<Float> f(final Float f) {
      return f == Float.MAX_VALUE ? Option.<Float>none() : some(f + 1F);
    }
  }, new Func<Float, Option<Float>>() {
    public Option<Float> f(final Float f) {
   ...
   */
  public static final Enumerator<Integer> intEnumerator = enumerator(new Func<Integer, Option<Integer>>() {
   ...
   */
  public static final Enumerator<BigInteger> bigintEnumerator = enumerator(new Func<BigInteger, Option<BigInteger>>() {
    public Option<BigInteger> f(final BigInteger i) {
      return some(i.add(BigInteger.ONE));
    }
  }, new Func<BigInteger, Option<BigInteger>>() {
    public Option<BigInteger> f(final BigInteger i) {
      return some(i.subtract(BigInteger.ONE));
    }
  }, Option.<BigInteger>none(), Option.<BigInteger>none(), bigintOrd, curry(
      new Func2<BigInteger, Long, Option<BigInteger>>() {
   ...
   */
  public static final Enumerator<BigDecimal> bigdecimalEnumerator = enumerator(new Func<BigDecimal, Option<BigDecimal>>() {
    public Option<BigDecimal> f(final BigDecimal i) {
      return some(i.add(BigDecimal.ONE));
    }
  }, new Func<BigDecimal, Option<BigDecimal>>() {
    public Option<BigDecimal> f(final BigDecimal i) {
      return some(i.subtract(BigDecimal.ONE));
    }
  }, Option.<BigDecimal>none(), Option.<BigDecimal>none(), bigdecimalOrd, curry(
      new Func2<BigDecimal, Long, Option<BigDecimal>>() {
   ...
   */
  public static final Enumerator<Long> longEnumerator = enumerator(new Func<Long, Option<Long>>() {
    public Option<Long> f(final Long i) {
      return i == Long.MAX_VALUE ? Option.<Long>none() : some(i + 1L);
    }
  }, new Func<Long, Option<Long>>() {
    public Option<Long> f(final Long i) {
   ...
   */
  public static final Enumerator<Short> shortEnumerator = enumerator(new Func<Short, Option<Short>>() {
    public Option<Short> f(final Short i) {
      return i == Short.MAX_VALUE ? Option.<Short>none() : some((short) (i + 1));
    }
  }, new Func<Short, Option<Short>>() {
    public Option<Short> f(final Short i) {
   ...
   */
  public static final Enumerator<Ordering> orderingEnumerator = enumerator(new Func<Ordering, Option<Ordering>>() {
    public Option<Ordering> f(final Ordering o) {
      return o == LT ? some(EQ) : o == EQ ? some(GT) : Option.<Ordering>none();
    }
  }, new Func<Ordering, Option<Ordering>>() {
    public Option<Ordering> f(final Ordering o) {
   ...
   */
  public static final Enumerator<Natural> naturalEnumerator = enumerator(new Func<Natural, Option<Natural>>() {
    public Option<Natural> f(final Natural n) {
      return Option.some(n.succ());
    }
  }, new Func<Natural, Option<Natural>>() {
    public Option<Natural> f(final Natural n) {
      return n.pred();
    }
  }, Option.<Natural>none(), some(Natural.ZERO), naturalOrd, curry(new Func2<Natural, Long, Option<Natural>>() {
    public Option<Natural> f(final Natural n, final Long l) {
      return some(n).apply(Natural.natural(l).map(Function.curry(new Func2<Natural, Natural, Natural>() {
