...
public abstract class Either<A, B> {
   ...
   */
  public final <X> X either(final Func<A, X> left, final Func<B, X> right) {
    return isLeft() ?
           left.f(left().value()) :
           right.f(right().value());
  }
  ...
  public final class LeftProjection<A, B> implements Iterable<A> {
     ...
     */
    public <X> Either<X, B> apply(final Either<Func<A, X>, B> e) {
      return e.left().bind(new Func<Func<A, X>, Either<X, B>>() {
        public Either<X, B> f(final Func<A, X> f) {
          return map(f);
        }
      });
    }
  ...
  public final class RightProjection<A, B> implements Iterable<B> {
     ...
     * @return The unit value.
     */
    public Unit foreach(final Func<B, Unit> f) {
      if (isRight())
        f.f(value());
     ...
     * @return The result of function application within either.
     */
    public <X> Either<A, X> apply(final Either<A, Func<B, X>> e) {
      return e.right().bind(new Func<Func<B, X>, Either<A, X>>() {
        public Either<A, X> f(final Func<B, X> f) {
          return map(f);
        }
      });
    }
     ...
     *         function to the value.
     */
    public boolean forall(final Func<B, Boolean> f) {
      return isLeft() || f.f(value());
    }
     ...
     *         function to the value.
     */
    public boolean exists(final Func<B, Boolean> f) {
      return isRight() && f.f(value());
    }
   ...
   */
  public static <A, B> Func<A, Either<A, B>> left_() {
    return new Func<A, Either<A, B>>() {
   ...
   */
  public static <A, B> Func<B, Either<A, B>> right_() {
    return new Func<B, Either<A, B>>() {
   ...
   */
  public static <A, B, X> Func<Func<A, X>, Func<Either<A, B>, Either<X, B>>> leftMap_() {
    return new Func<Func<A, X>, Func<Either<A, B>, Either<X, B>>>() {
      public Func<Either<A, B>, Either<X, B>> f(final Func<A, X> axf) {
        return new Func<Either<A, B>, Either<X, B>>() {
   ...
   */
  public static <A, B, X> Func<Func<B, X>, Func<Either<A, B>, Either<A, X>>> rightMap_() {
    return new Func<Func<B, X>, Func<Either<A, B>, Either<A, X>>>() {
      public Func<Either<A, B>, Either<A, X>> f(final Func<B, X> axf) {
        return new Func<Either<A, B>, Either<A, X>>() {
  ...
  public static <A, B> Either<A, B> joinLeft(final Either<Either<A, B>, B> e) {
    final Func<Either<A, B>, Either<A, B>> id = identity();
  ...
  public static <A, X> Either<List<A>, X> sequenceLeft(final List<Either<A, X>> a) {
    return a.isEmpty() ?
           ...
           a.head().left().bind(new Func<A, Either<List<A>, X>>() {
  ...
  public static <B, X> Either<X, List<B>> sequenceRight(final List<Either<X, B>> a) {
    return a.isEmpty() ?
           ...
           a.head().right().bind(new Func<B, Either<X, List<B>>>() {
  ...
  public static <A, B> List<A> lefts(final List<Either<A, B>> es) {
    return es.foldRight(new Func<Either<A, B>, Func<List<A>, List<A>>>() {
  ...
  public static <A, B> List<B> rights(final List<Either<A, B>> es) {
    return es.foldRight(new Func<Either<A, B>, Func<List<B>, List<B>>>() {
