...
public abstract class HList<A extends HList<A>> {
  ...
  public static final class HAppend<A, B, C> {
    private final Func2<A, B, C> append;

    private HAppend(final Func2<A, B, C> f) {
      append = f;
    }
    ...
    public static <L extends HList<L>> HAppend<HNil, L, L> append() {
      return new HAppend<HNil, L, L>(new Func2<HNil, L, L>() {
    ...
    HAppend<HCons<X, A>, B, HCons<X, C>> append(final H h) {
      return new HAppend<HCons<X, A>, B, HCons<X, C>>(new Func2<HCons<X, A>, B, HCons<X, C>>() {
  ...
  public abstract static class Apply<F$, A, R> {
     ...
     */
    public static <X, Y> Apply<Func<X, Y>, X, Y> f() {
      return new Apply<Func<X, Y>, X, Y>() {
        public Y apply(final Func<X, Y> f, final X x) {
          return f.f(x);
        }
      };
    }
     ...
     */
    public static <X, Y, Z> Apply<Unit, P2<Func<X, Y>, Func<Y, Z>>, Func<X, Z>> comp() {
      return new Apply<Unit, P2<Func<X, Y>, Func<Y, Z>>, Func<X, Z>>() {
        public Func<X, Z> apply(final Unit f, final P2<Func<X, Y>, Func<Y, Z>> fs) {
  ...
  public static final class HFoldr<G, V, L, R> {
    ...
    private final Func3<G, V, L, R> foldRight;

    private HFoldr(final Func3<G, V, L, R> foldRight) {
    ...
    public static <G, V> HFoldr<G, V, HNil, V> hFoldr() {
      return new HFoldr<G, V, HNil, V>(new Func3<G, V, HNil, V>() {
    ...
    HFoldr<G, V, HCons<E, L>, RR> hFoldr(final PP p, final H h) {
      return new HFoldr<G, V, HCons<E, L>, RR>(new Func3<G, V, HCons<E, L>, RR>() {
