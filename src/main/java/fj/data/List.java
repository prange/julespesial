...
public abstract class List<A> implements Iterable<A> {
  ...
  public final int length() {
    return foldLeft(new Func<Integer, Func<A, Integer>>() {
      public Func<A, Integer> f(final Integer i) {
        return new Func<A, Integer>() {
   ...
   */
  public final <B> B list(final B nil, final Func<A, Func<List<A>, B>> cons) {
  ...
  public final Stream<A> toStream() {
    ...
    return foldRight(new Func<A, Func<Stream<A>, Stream<A>>>() {
      public Func<Stream<A>, Stream<A>> f(final A a) {
        return new Func<Stream<A>, Stream<A>>() {
   ...
   */
  public final <B> List<B> map(final Func<A, B> f) {
   ...
   */
  public final List<A> filter(final Func<A, Boolean> f) {
   ...
   */
  public final List<A> removeAll(final Func<A, Boolean> f) {
   ...
   */
  public final List<A> takeWhile(final Func<A, Boolean> f) {
    final Buffer<A> b = empty();
    boolean taking = true;
   ...
   */
  public final List<A> dropWhile(final Func<A, Boolean> f) {
    List<A> xs;
   ...
   *         the given predicate and the second element is the remainder of the list.
   */
  public final P2<List<A>, List<A>> span(final Func<A, Boolean> p) {
    final Buffer<A> b = empty();
    for (List<A> xs = this; xs.isNotEmpty(); xs = xs.tail()) {
      if (p.f(xs.head()))
        b.snoc(xs.head());
   ...
   *         the given predicate and the second element is the remainder of the list.
   */
  public final P2<List<A>, List<A>> breakk(final Func<A, Boolean> p) {
    return span(new Func<A, Boolean>() {
   ...
   */
  public final <B> List<B> bind(final Func<A, List<B>> f) {
   ...
   * @return A new list after performing the map, then final join.
   */
  public final <B, C> List<C> bind(final List<B> lb, final Func<A, Func<B, C>> f) {
   ...
   * @return A new list after performing the map, then final join.
   */
  public final <B, C> List<C> bind(final List<B> lb, final Func2<A, B, C> f) {
   ...
   */
  public static <A, B, C> Func<List<A>, Func<List<B>, List<C>>> liftM2(final Func<A, Func<B, C>> f) {
    return curry(new Func2<List<A>, List<B>, List<C>>() {
   ...
   * @return A new list after performing the map, then final join.
   */
  public final <B, C, D> List<D> bind(final List<B> lb, final List<C> lc, final Func<A, Func<B, Func<C, D>>> f) {
  ...
  public final <B, C, D, E, F$> List<F$> bind(final List<B> lb, final List<C> lc, final List<D> ld, final List<E> le,
                                        final Func<A, Func<B, Func<C, Func<D, Func<E, F$>>>>> f) {
  ...
  public final <B, C, D, E, F$, G> List<G> bind(final List<B> lb, final List<C> lc, final List<D> ld, final List<E> le,
                                          final List<F$> lf, final Func<A, Func<B, Func<C, Func<D, Func<E, Func<F$, G>>>>>> f) {
  ...
  public final <B> List<B> sequence(final List<B> bs) {
    final Func<A, List<B>> c = constant(bs);
    return bind(c);
  }
   ...
   */
  public final <B> List<B> apply(final List<Func<A, B>> lf) {
    return lf.bind(new Func<Func<A, B>, List<B>>() {
      public List<B> f(final Func<A, B> f) {
        return map(f);
      }
    });
  }
   ...
   */
  public final <B> B foldRight(final Func<A, Func<B, B>> f, final B b) {
   ...
   * @return The final result after the right-fold reduction.
   */
  public final <B> B foldRight(final Func2<A, B, B> f, final B b) {
   ...
   */
  public final <B> Trampoline<B> foldRightC(final Func2<A, B, B> f, final B b) {
  ...
  public final List<A> reverse() {
    return foldLeft(new Func<List<A>, Func<A, List<A>>>() {
      public Func<A, List<A>> f(final List<A> as) {
        return new Func<A, List<A>>() {
  ...
  public final P2<List<A>, List<A>> splitAt(final int i) {
    ...
    for (List<A> xs = this; xs.isNotEmpty(); xs = xs.tail()) {
      final A h = xs.head();
      s = c < i ? s.map1(new Func<List<A>, List<A>>() {
        public List<A> f(final List<A> as) {
          return as.snoc(h);
        }
      }) : s.map2(new Func<List<A>, List<A>>() {
        public List<A> f(final List<A> as) {
          return as.snoc(h);
        }
      });
  ...
  public final List<List<A>> partition(final int n) {
    ...
    return unfold(new Func<List<A>, Option<P2<List<A>, List<A>>>>() {
   ...
   */
  public final <B, C> List<C> zipWith(List<B> bs, final Func<A, Func<B, C>> f) {
   ...
   * @return A new list with a length the same as the shortest of this list and the given list.
   */
  public final <B, C> List<C> zipWith(final List<B> bs, final Func2<A, B, C> f) {
   ...
   */
  public static <A, B, C> Func<List<A>, Func<List<B>, Func<Func<A, Func<B, C>>, List<C>>>> zipWith() {
    return curry(new Func3<List<A>, List<B>, Func<A, Func<B, C>>, List<C>>() {
      public List<C> f(final List<A> as, final List<B> bs, final Func<A, Func<B, C>> f) {
   ...
   */
  public static <A, B> Func<List<A>, Func<List<B>, List<P2<A, B>>>> zip() {
    return curry(new Func2<List<A>, List<B>, List<P2<A, B>>>() {
  ...
  public final List<A> nub(final Equal<A> eq) {
    return isEmpty() ? this : cons(head(), tail().filter(new Func<A, Boolean>() {
      public Boolean f(final A a) {
        return !eq.eq(a, head());
      }
    }).nub(eq));
   ...
   */
  public static <A> Func<List<A>, A> head_() {
   ...
   */
  public static <A> Func<List<A>, List<A>> tail_() {
   ...
   *         in this list.
   */
  public final <B, C> Func<B, List<C>> mapM(final Func<A, Func<B, C>> f) {
   ...
   */
  public final <B> Option<List<B>> mapMOption(final Func<A, Option<B>> f) {
    return foldRight(new Func2<A, Option<List<B>>, Option<List<B>>>() {
      public Option<List<B>> f(final A a, final Option<List<B>> bs) {
        return f.f(a).bind(new Func<B, Option<List<B>>>() {
          public Option<List<B>> f(final B b) {
            return bs.map(new Func<List<B>, List<B>>() {
   ...
   */
  public final <B> Trampoline<List<B>> mapMTrampoline(final Func<A, Trampoline<B>> f) {
    return foldRight(new Func2<A, Trampoline<List<B>>, Trampoline<List<B>>>() {
      public Trampoline<List<B>> f(final A a, final Trampoline<List<B>> bs) {
        return f.f(a).bind(new Func<B, Trampoline<List<B>>>() {
   ...
   */
  public final List<A> insertBy(final Func<A, Func<A, Ordering>> f, final A x) {
    List<A> ys = this;
    Buffer<A> xs = empty();
   ...
   */
  public static <A> Func<List<A>, Integer> length_() {
    return new Func<List<A>, Integer>() {
   ...
   */
  public static <A> Func<A, Func<List<A>, List<A>>> cons() {
    return new Func<A, Func<List<A>, List<A>>>() {
      public Func<List<A>, List<A>> f(final A a) {
        return new Func<List<A>, List<A>>() {
   ...
   */
  public static <A> Func<A, List<A>> cons(final List<A> tail) {
    return new Func<A, List<A>>() {
      public List<A> f(final A a) {
        return tail.cons(a);
      }
   ...
   */
  public static <A> Func<List<A>, List<A>> cons_(final A a) {
    return new Func<List<A>, List<A>>() {
      public List<A> f(final List<A> as) {
        return as.cons(a);
      }
   ...
   */
  public static <A> Func<List<A>, Boolean> isEmpty_() {
    return new Func<List<A>, Boolean>() {
   ...
   */
  public static <A> Func<List<A>, Boolean> isNotEmpty_() {
    return new Func<List<A>, Boolean>() {
      public Boolean f(final List<A> as) {
  ...
  public static <A> List<A> join(final List<List<A>> o) {
    final Func<List<A>, List<A>> id = identity();
    return o.bind(id);
  }
   ...
   */
  public static <A> Func<List<List<A>>, List<A>> join() {
    return new Func<List<List<A>>, List<A>>() {
   ...
   */
  public static <A, B> List<A> unfold(final Func<B, Option<P2<A, B>>> f, final B b) {
    Buffer<A> buf = empty();
   ...
   */
  public static Func<String, List<Character>> fromString() {
    return new Func<String, List<Character>>() {
  ...
  public static String asString(final List<Character> cs) {
    ...
    cs.foreach(new Func<Character, Unit>() {
   ...
   */
  public static Func<List<Character>, String> asString() {
    return new Func<List<Character>, String>() {
   ...
   *         the second item by applying the function on the previous result and so on.
   */
  public static <A> List<A> iterateWhile(final Func<A, A> f, final Func<A, Boolean> p, final A a) {
    return unfold(
  ...
  public static <A, B> Option<B> lookup(final Equal<A> e, final List<P2<A, B>> x, final A a) {
    return x.find(new Func<P2<A, B>, Boolean>() {
  ...
  /**
   * Returns a partially applied version of {@link #lookup(Equal, fj.data.List, Object)}.
   *
   * @param e The test for equality on keys.
   * @return A partially applied version of {@link #lookup(Equal , fj.data.List, Object)}.
   */
  public static <A, B> Func2<List<P2<A, B>>, A, Option<B>> lookup(final Equal<A> e) {
    return new Func2<List<P2<A, B>>, A, Option<B>>() {
   ...
   */
  public static <A, B> Func<Func<A, List<B>>, Func<List<A>, List<B>>> bind_() {
    return curry(new Func2<Func<A, List<B>>, List<A>, List<B>>() {
      public List<B> f(final Func<A, List<B>> f, final List<A> as) {
        return as.bind(f);
      }
    });
  }
   ...
   */
  public static <A, B> Func<Func<A, B>, Func<List<A>, List<B>>> map_() {
    return curry(new Func2<Func<A, B>, List<A>, List<B>>() {
      public List<B> f(final Func<A, B> f, final List<A> as) {
        return as.map(f);
      }
    });
  }
   ...
   */
  public static <A, B> Func<B, List<A>> sequence_(final List<Func<B, A>> fs) {
   ...
   */
  public static <A, B> Func<Func<B, Func<A, B>>, Func<B, Func<List<A>, B>>> foldLeft() {
    return curry(new Func3<Func<B, Func<A, B>>, B, List<A>, B>() {
      public B f(final Func<B, Func<A, B>> f, final B b, final List<A> as) {
   ...
   */
  public static <A> Func<Integer, Func<List<A>, List<A>>> take() {
    return curry(new Func2<Integer, List<A>, List<A>>() {
   ...
   * of the {@link fj.data.List immutable singly linked list structure}.
   */
  public static final class Buffer<A> implements Iterable<A> {
    ...
    /**
     * Obtain a string representation of this list using the toString implementations of the members.  Uses Show.listShow with Func2 argument and may
     * not be very performant.
     *
     * @return a String representation of the list
     */
    @Override public String toString() {
        return Show.listShow( Show.<A>anyShow() ).show( this ).foldLeft( new Func2<String, Character, String>() {
