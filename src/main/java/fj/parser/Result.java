...
public final class Result<I, A> implements Iterable<A> {
   ...
   */
  public <J> Result<J, A> mapRest(final Func<I, J> f) {
   ...
   */
  public <J> Func<Func<I, J>, Result<J, A>> mapRest() {
    return new Func<Func<I, J>, Result<J, A>>() {
      public Result<J, A> f(final Func<I, J> f) {
        return mapRest(f);
      }
    };
  }
   ...
   */
  public <B> Result<I, B> mapValue(final Func<A, B> f) {
   ...
   */
  public <B> Func<Func<A, B>, Result<I, B>> mapValue() {
    return new Func<Func<A, B>, Result<I, B>>() {
      public Result<I, B> f(final Func<A, B> f) {
        return mapValue(f);
      }
    };
  }
   ...
   */
  public <B, J> Result<J, B> bimap(final Func<I, J> f, final Func<A, B> g) {
   ...
   */
  public <B, J> Func<Func<I, J>, Func<Func<A, B>, Result<J, B>>> bimap() {
    return curry(new Func2<Func<I, J>, Func<A, B>, Result<J, B>>() {
      public Result<J, B> f(final Func<I, J> f, final Func<A, B> g) {
        return bimap(f, g);
      }
    });
  }
   ...
   */
  public static <A, I> Func<I, Func<A, Result<I, A>>> result() {
    return curry(new Func2<I, A, Result<I, A>>() {
