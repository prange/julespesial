...
public final class Parser<I, A, E> {
  private final Func<I, Validation<E, Result<I, A>>> f;

  private Parser(final Func<I, Validation<E, Result<I, A>>> f) {
    this.f = f;
  }
   ...
   */
  public <Z> Parser<Z, A, E> xmap(final Func<I, Z> f, final Func<Z, I> g) {
    return parser(new Func<Z, Validation<E, Result<Z, A>>>() {
      public Validation<E, Result<Z, A>> f(final Z z) {
        return parse(g.f(z)).map(new Func<Result<I, A>, Result<Z, A>>() {
   ...
   */
  public <B> Parser<I, B, E> map(final Func<A, B> f) {
    return parser(new Func<I, Validation<E, Result<I, B>>>() {
      public Validation<E, Result<I, B>> f(final I i) {
        return parse(i).map(new Func<Result<I, A>, Result<I, B>>() {
   ...
   */
  public Parser<I, A, E> filter(final Func<A, Boolean> f, final E e) {
    return parser(new Func<I, Validation<E, Result<I, A>>>() {
      public Validation<E, Result<I, A>> f(final I i) {
        return parse(i).bind(new Func<Result<I, A>, Validation<E, Result<I, A>>>() {
   ...
   */
  public <B> Parser<I, B, E> bind(final Func<A, Parser<I, B, E>> f) {
    return parser(new Func<I, Validation<E, Result<I, B>>>() {
      public Validation<E, Result<I, B>> f(final I i) {
        return parse(i).bind(new Func<Result<I, A>, Validation<E, Result<I, B>>>() {
   ...
   * @return A new parser after performing the map, then final join.
   */
  public <B, C> Parser<I, C, E> bind(final Parser<I, B, E> pb, final Func<A, Func<B, C>> f) {
  ...
  public <B, C, D> Parser<I, D, E> bind(final Parser<I, B, E> pb, final Parser<I, C, E> pc,
                                        final Func<A, Func<B, Func<C, D>>> f) {
  ...
  public <B, C, D, E$> Parser<I, E$, E> bind(final Parser<I, B, E> pb, final Parser<I, C, E> pc,
                                             final Parser<I, D, E> pd, final Func<A, Func<B, Func<C, Func<D, E$>>>> f) {
  ...
  public <B> Parser<I, B, E> sequence(final Parser<I, B, E> p) {
    return bind(new Func<A, Parser<I, B, E>>() {
   ...
   */
  public <B> Parser<I, B, E> apply(final Parser<I, Func<A, B>, E> p) {
    return p.bind(new Func<Func<A, B>, Parser<I, B, E>>() {
      public Parser<I, B, E> f(final Func<A, B> f) {
        return map(f);
      }
    });
  }
  ...
  public Parser<I, A, E> or(final P1<Parser<I, A, E>> alt, final Semigroup<E> s) {
    return parser(new Func<I, Validation<E, Result<I, A>>>() {
      public Validation<E, Result<I, A>> f(final I i) {
        return parse(i).f().bind(new Func<E, Validation<E, Result<I, A>>>() {
  ...
  public Parser<I, Unit, E> not(final P1<E> e) {
    return parser(new Func<I, Validation<E, Result<I, Unit>>>() {
  ...
  public Parser<I, Stream<A>, E> repeat1() {
      return bind(new Func<A, Parser<I, Stream<A>, E>>() {
          public Parser<I, Stream<A>, E> f(final A a) {
              return repeat().map(new Func<Stream<A>, Stream<A>>() {
   ...
   */
  public <K> Parser<I, A, K> mapError(final Func<E, K> f) {
    return parser(new Func<I, Validation<K, Result<I, A>>>() {
   ...
   */
  public static <I, A, E> Parser<I, A, E> parser(final Func<I, Validation<E, Result<I, A>>> f) {
  ...
  public static <I, A, E> Parser<I, List<A>, E> sequence(final List<Parser<I, A, E>> ps) {
    return ps.isEmpty() ?
        ...
        ps.head().bind(new Func<A, Parser<I, List<A>, E>>() {
  ...
  public static final class StreamParser {
    ...
    public static <I, E> Parser<Stream<I>, I, E> element(final P1<E> e) {
      return parser(new Func<Stream<I>, Validation<E, Result<Stream<I>, I>>>() {
     ...
     */
    public static <I, E> Parser<Stream<I>, I, E> satisfy(final P1<E> missing, final Func<I, E> sat,
                                                         final Func<I, Boolean> f) {
      return StreamParser.<I, E>element(missing).bind(new Func<I, Parser<Stream<I>, I, E>>() {
     ...
     * @return A parser that produces an element from the stream that satisfies the given predicate, or fails.
     */
    public static <I, E> Parser<Stream<I>, I, E> satisfy(final E missing, final Func<I, E> sat, final Func<I, Boolean> f) {
  ...
  public static final class CharsParser {
     ...
     */
    public static <E> Parser<Stream<Character>, Character, E> character(final P1<E> missing, final Func<Character, E> sat,
                                                                        final char c) {
      return StreamParser.satisfy(missing, sat, new Func<Character, Boolean>() {
     ...
     * @return A parser that produces the given character or fails otherwise.
     */
    public static <E> Parser<Stream<Character>, Character, E> character(final E missing, final Func<Character, E> sat,
                                                                        final char c) {
     ...
     */
    public static <E> Parser<Stream<Character>, String, E> string(final P1<E> missing, final Func<Character, E> sat,
                                                                  final String s) {
      return characters(missing, sat, List.fromString(s).toStream()).map(new Func<Stream<Character>, String>() {
     ...
     * @return A parser that produces the given string or fails otherwise.
     */
    public static <E> Parser<Stream<Character>, String, E> string(final E missing, final Func<Character, E> sat,
                                                                  final String s) {
     ...
     */
    public static <E> Parser<Stream<Character>, Digit, E> digit(final P1<E> missing, final Func<Character, E> sat) {
      return StreamParser.satisfy(missing, sat, new Func<Character, Boolean>() {
        public Boolean f(final Character c) {
          return Character.isDigit(c);
        }
      }).map(new Func<Character, Digit>() {
     ...
     * @return A parser that produces a digit (0 to 9).
     */
    public static <E> Parser<Stream<Character>, Digit, E> digit(final E missing, final Func<Character, E> sat) {
     ...
     */
    public static <E> Parser<Stream<Character>, Character, E> lower(final P1<E> missing, final Func<Character, E> sat) {
      return StreamParser.satisfy(missing, sat, new Func<Character, Boolean>() {
        public Boolean f(final Character c) {
     ...
     * @see Character#isLowerCase(char)
     */
    public static <E> Parser<Stream<Character>, Character, E> lower(final E missing, final Func<Character, E> sat) {
     ...
     */
    public static <E> Parser<Stream<Character>, Character, E> upper(final P1<E> missing, final Func<Character, E> sat) {
      return StreamParser.satisfy(missing, sat, new Func<Character, Boolean>() {
        public Boolean f(final Character c) {
     ...
     * @see Character#isUpperCase(char)
     */
    public static <E> Parser<Stream<Character>, Character, E> upper(final E missing, final Func<Character, E> sat) {
     ...
     */
    public static <E> Parser<Stream<Character>, Character, E> defined(final P1<E> missing, final Func<Character, E> sat) {
      return StreamParser.satisfy(missing, sat, new Func<Character, Boolean>() {
        public Boolean f(final Character c) {
     ...
     * @see Character#isDefined(char)
     */
    public static <E> Parser<Stream<Character>, Character, E> defined(final E missing, final Func<Character, E> sat) {
     ...
     * @see Character#isISOControl(char)
     */
    public static <E> Parser<Stream<Character>, Character, E> isoControl(final E missing, final Func<Character, E> sat) {
     ...
     */
    public static <E> Parser<Stream<Character>, Character, E> alpha(final P1<E> missing, final Func<Character, E> sat) {
      return StreamParser.satisfy(missing, sat, new Func<Character, Boolean>() {
        public Boolean f(final Character c) {
     ...
     * @see Character#isLetter(char)
     */
    public static <E> Parser<Stream<Character>, Character, E> alpha(final E missing, final Func<Character, E> sat) {
     ...
     */
    public static <E> Parser<Stream<Character>, Character, E> alphaNum(final P1<E> missing, final Func<Character, E> sat) {
      return StreamParser.satisfy(missing, sat, new Func<Character, Boolean>() {
        public Boolean f(final Character c) {
     ...
     * @see Character#isLetterOrDigit(char)
     */
    public static <E> Parser<Stream<Character>, Character, E> alphaNum(final E missing, final Func<Character, E> sat) {
     ...
     * @see Character#isLowSurrogate(char)
     */
    public static <E> Parser<Stream<Character>, Character, E> lowSurrogate(final E missing, final Func<Character, E> sat) {
     ...
     */
    public static <E> Parser<Stream<Character>, Character, E> mirrored(final P1<E> missing, final Func<Character, E> sat) {
      return StreamParser.satisfy(missing, sat, new Func<Character, Boolean>() {
        public Boolean f(final Character c) {
     ...
     * @see Character#isMirrored(char)
     */
    public static <E> Parser<Stream<Character>, Character, E> mirrored(final E missing, final Func<Character, E> sat) {
     ...
     */
    public static <E> Parser<Stream<Character>, Character, E> space(final P1<E> missing, final Func<Character, E> sat) {
      return StreamParser.satisfy(missing, sat, new Func<Character, Boolean>() {
        public Boolean f(final Character c) {
     ...
     * @see Character#isSpace(char)
     */
    public static <E> Parser<Stream<Character>, Character, E> space(final E missing, final Func<Character, E> sat) {
     ...
     * @see Character#isTitleCase(char)
     */
    public static <E> Parser<Stream<Character>, Character, E> titleCase(final E missing, final Func<Character, E> sat) {
     ...
     * @see Character#isWhitespace(char)
     */
    public static <E> Parser<Stream<Character>, Character, E> whitespace(final E missing, final Func<Character, E> sat) {
