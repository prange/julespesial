...
public final class Hash<A> {
  private final Func<A, Integer> f;

  private Hash(final Func<A, Integer> f) {
    this.f = f;
  }
   ...
   * @return A new hash.
   */
  public <B> Hash<B> comap(final Func<B, A> g) {
   ...
   */
  public static <A> Hash<A> hash(final Func<A, Integer> f) {
    return new Hash<A>(f);
  }
  ...
  public static <A> Hash<A> anyHash() {
    return new Hash<A>(new Func<A, Integer>() {
   ...
   */
  public static final Hash<StringBuffer> stringBufferHash = new Hash<StringBuffer>(new Func<StringBuffer, Integer>() {
   ...
   */
  public static final Hash<StringBuilder> stringBuilderHash = new Hash<StringBuilder>(new Func<StringBuilder, Integer>() {
  ...
  public static <A, B> Hash<Either<A, B>> eitherHash(final Hash<A> ha, final Hash<B> hb) {
    return new Hash<Either<A, B>>(new Func<Either<A, B>, Integer>() {
  ...
  public static <A> Hash<List<A>> listHash(final Hash<A> ha) {
    return new Hash<List<A>>(new Func<List<A>, Integer>() {
  ...
  public static <A> Hash<Option<A>> optionHash(final Hash<A> ha) {
    return new Hash<Option<A>>(new Func<Option<A>, Integer>() {
  ...
  public static <A> Hash<Stream<A>> streamHash(final Hash<A> ha) {
    return new Hash<Stream<A>>(new Func<Stream<A>, Integer>() {
  ...
  public static <A> Hash<Array<A>> arrayHash(final Hash<A> ha) {
    return new Hash<Array<A>>(new Func<Array<A>, Integer>() {
  ...
  public static <A, B> Hash<P2<A, B>> p2Hash(final Hash<A> ha, final Hash<B> hb) {
    return new Hash<P2<A, B>>(new Func<P2<A, B>, Integer>() {
  ...
  public static <A, B, C> Hash<P3<A, B, C>> p3Hash(final Hash<A> ha, final Hash<B> hb, final Hash<C> hc) {
    return new Hash<P3<A, B, C>>(new Func<P3<A, B, C>, Integer>() {
  ...
  public static <A, B, C, D> Hash<P4<A, B, C, D>> p4Hash(final Hash<A> ha, final Hash<B> hb, final Hash<C> hc,
                                                         final Hash<D> hd) {
    return new Hash<P4<A, B, C, D>>(new Func<P4<A, B, C, D>, Integer>() {
  ...
  public static <A, B, C, D, E> Hash<P5<A, B, C, D, E>> p5Hash(final Hash<A> ha, final Hash<B> hb, final Hash<C> hc,
    ...
    return new Hash<P5<A, B, C, D, E>>(new Func<P5<A, B, C, D, E>, Integer>() {
  ...
  public static <A, B, C, D, E, F$> Hash<P6<A, B, C, D, E, F$>> p6Hash(final Hash<A> ha, final Hash<B> hb,
    ...
    return new Hash<P6<A, B, C, D, E, F$>>(new Func<P6<A, B, C, D, E, F$>, Integer>() {
  ...
  public static <A, B, C, D, E, F$, G> Hash<P7<A, B, C, D, E, F$, G>> p7Hash(final Hash<A> ha, final Hash<B> hb,
                                                                             ...
                                                                             final Hash<E> he, final Hash<F$> hf,
                                                                             final Hash<G> hg) {
    return new Hash<P7<A, B, C, D, E, F$, G>>(new Func<P7<A, B, C, D, E, F$, G>, Integer>() {
  ...
  public static <A, B, C, D, E, F$, G, H> Hash<P8<A, B, C, D, E, F$, G, H>> p8Hash(final Hash<A> ha, final Hash<B> hb,
    ...
    return new Hash<P8<A, B, C, D, E, F$, G, H>>(new Func<P8<A, B, C, D, E, F$, G, H>, Integer>() {
