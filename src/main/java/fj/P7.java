...
public abstract class P7<A, B, C, D, E, F, G> {
   ...
   */
  public final <X> P7<X, B, C, D, E, F, G> map1(final Func<A, X> f) {
   ...
   * @return A product with the given function applied.
   */
  public final <X> P7<A, X, C, D, E, F, G> map2(final Func<B, X> f) {
   ...
   * @return A product with the given function applied.
   */
  public final <X> P7<A, B, X, D, E, F, G> map3(final Func<C, X> f) {
   ...
   * @return A product with the given function applied.
   */
  public final <X> P7<A, B, C, X, E, F, G> map4(final Func<D, X> f) {
   ...
   * @return A product with the given function applied.
   */
  public final <X> P7<A, B, C, D, X, F, G> map5(final Func<E, X> f) {
   ...
   * @return A product with the given function applied.
   */
  public final <X> P7<A, B, C, D, E, X, G> map6(final Func<F, X> f) {
   ...
   * @return A product with the given function applied.
   */
  public final <X> P7<A, B, C, D, E, F, X> map7(final Func<G, X> f) {
   ...
   */
  public static <A, B, C, D, E, F$, G> Func<P7<A, B, C, D, E, F$, G>, A> __1() {
    return new Func<P7<A, B, C, D, E, F$, G>, A>() {
   ...
   */
  public static <A, B, C, D, E, F$, G> Func<P7<A, B, C, D, E, F$, G>, B> __2() {
    return new Func<P7<A, B, C, D, E, F$, G>, B>() {
   ...
   */
  public static <A, B, C, D, E, F$, G> Func<P7<A, B, C, D, E, F$, G>, C> __3() {
    return new Func<P7<A, B, C, D, E, F$, G>, C>() {
   ...
   */
  public static <A, B, C, D, E, F$, G> Func<P7<A, B, C, D, E, F$, G>, D> __4() {
    return new Func<P7<A, B, C, D, E, F$, G>, D>() {
   ...
   */
  public static <A, B, C, D, E, F$, G> Func<P7<A, B, C, D, E, F$, G>, E> __5() {
    return new Func<P7<A, B, C, D, E, F$, G>, E>() {
   ...
   */
  public static <A, B, C, D, E, F$, G> Func<P7<A, B, C, D, E, F$, G>, F$> __6() {
    return new Func<P7<A, B, C, D, E, F$, G>, F$>() {
   ...
   */
  public static <A, B, C, D, E, F$, G> Func<P7<A, B, C, D, E, F$, G>, G> __7() {
    return new Func<P7<A, B, C, D, E, F$, G>, G>() {
