...
public abstract class P3<A, B, C> {
   ...
   */
  public final <X> P3<X, B, C> map1(final Func<A, X> f) {
    return new P3<X, B, C>() {
      public X _1() {
   ...
   * @return A product with the given function applied.
   */
  public final <X> P3<A, X, C> map2(final Func<B, X> f) {
    return new P3<A, X, C>() {
      public A _1() {
        return P3.this._1();
      }
   ...
   * @return A product with the given function applied.
   */
  public final <X> P3<A, B, X> map3(final Func<C, X> f) {
    return new P3<A, B, X>() {
      public A _1() {
        return P3.this._1();
      }
   ...
   */
  public static <A, B, C> Func<P3<A, B, C>, A> __1() {
    return new Func<P3<A, B, C>, A>() {
   ...
   */
  public static <A, B, C> Func<P3<A, B, C>, B> __2() {
    return new Func<P3<A, B, C>, B>() {
   ...
   */
  public static <A, B, C> Func<P3<A, B, C>, C> __3() {
    return new Func<P3<A, B, C>, C>() {
