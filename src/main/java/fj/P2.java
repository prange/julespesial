...
public abstract class P2<A, B> {
   ...
   */
  public final <X> P2<X, B> map1(final Func<A, X> f) {
    return new P2<X, B>() {
      public X _1() {
   ...
   * @return A product with the given function applied.
   */
  public final <X> P2<A, X> map2(final Func<B, X> f) {
    return new P2<A, X>() {
      public A _1() {
        return P2.this._1();
      }
   ...
   */
  public final <C, D> P2<C, D> split(final Func<A, C> f, final Func<B, D> g) {
    final Func<P2<A, D>, P2<C, D>> ff = map1_(f);
    final Func<P2<A, B>, P2<A, D>> gg = map2_(g);
   ...
   */
  public final <C> P2<C, B> cobind(final Func<P2<A, B>, C> k) {
    return new P2<C, B>() {
  ...
  public final P2<P2<A, B>, B> duplicate() {
    final Func<P2<A, B>, P2<A, B>> id = identity();
    return cobind(id);
  }
  ...
  public final <C> P2<C, B> inject(final C c) {
    final Func<P2<A, B>, C> co = constant(c);
    return cobind(co);
  }
   ...
   */
  public final <C> List<C> sequenceW(final List<Func<P2<A, B>, C>> fs) {
    List.Buffer<C> cs = List.Buffer.empty();
    for (final Func<P2<A, B>, C> f : fs)
      cs = cs.snoc(f.f(this));
    return cs.toList();
  }
   ...
   */
  public final <C> Stream<C> sequenceW(final Stream<Func<P2<A, B>, C>> fs) {
    return fs.isEmpty()
           ? Stream.<C>nil()
   ...
   */
  public static <A, B, C, D> Func<P2<A, B>, P2<C, D>> split_(final Func<A, C> f, final Func<B, D> g) {
    return new Func<P2<A, B>, P2<C, D>>() {
   ...
   */
  public static <A, B, X> Func<P2<A, B>, P2<X, B>> map1_(final Func<A, X> f) {
    return new Func<P2<A, B>, P2<X, B>>() {
   ...
   */
  public static <A, B, X> Func<P2<A, B>, P2<A, X>> map2_(final Func<B, X> f) {
    return new Func<P2<A, B>, P2<A, X>>() {
   ...
   */
  public static <B, C, D> P2<C, D> fanout(final Func<B, C> f, final Func<B, D> g, final B b) {
   ...
   */
  public static <A, B> P2<B, B> map(final Func<A, B> f, final P2<A, A> p) {
    return p.split(f, f);
  }
   ...
   */
  public static <A, B> Func<P2<A, B>, P2<B, A>> swap_() {
    return new Func<P2<A, B>, P2<B, A>>() {
   ...
   */
  public static <A, B> Func<P2<A, B>, A> __1() {
    return new Func<P2<A, B>, A>() {
   ...
   */
  public static <A, B> Func<P2<A, B>, B> __2() {
    return new Func<P2<A, B>, B>() {
   ...
   */
  public static <A, B, C> Func<P2<A, B>, C> tuple(final Func<A, Func<B, C>> f) {
   ...
   * @return The function, transformed to operate on on a product-2
   */
  public static <A, B, C> Func<P2<A, B>, C> tuple(final Func2<A, B, C> f) {
   ...
   */
  public static <A, B, C> Func2<A, B, C> untuple(final Func<P2<A, B>, C> f) {
