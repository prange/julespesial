...
public final class Show<A> {
  private final Func<A, Stream<Character>> f;

  private Show(final Func<A, Stream<Character>> f) {
    this.f = f;
  }
   ...
   * @return A new show.
   */
  public <B> Show<B> comap(final Func<B, A> f) {
   ...
   */
  public Func<A, String> showS_() {
    return new Func<A, String>() {
   ...
   * @return the transformation equivalent to this show.
   */
  public Func<A, Stream<Character>> show_() {
    return f;
  }
   ...
   */
  public static <A> Show<A> show(final Func<A, Stream<Character>> f) {
    return new Show<A>(f);
  }
  ...
  public static <A> Show<Option<A>> optionShow(final Show<A> sa) {
    return new Show<Option<A>>(new Func<Option<A>, Stream<Character>>() {
  ...
  public static <A> Show<List<A>> listShow(final Show<A> sa) {
    return new Show<List<A>>(new Func<List<A>, Stream<Character>>() {
  ...
  public static <A> Show<Stream<A>> streamShow(final Show<A> sa) {
    return new Show<Stream<A>>(new Func<Stream<A>, Stream<Character>>() {
  ...
  public static <A> Show<Array<A>> arrayShow(final Show<A> sa) {
    return new Show<Array<A>>(new Func<Array<A>, Stream<Character>>() {
  ...
  public static <A> Show<P1<A>> p1Show(final Show<A> sa) {
    return new Show<P1<A>>(new Func<P1<A>, Stream<Character>>() {
  ...
  public static <A, B> Show<P2<A, B>> p2Show(final Show<A> sa, final Show<B> sb) {
    return new Show<P2<A, B>>(new Func<P2<A, B>, Stream<Character>>() {
  ...
  public static <A, B, C> Show<P3<A, B, C>> p3Show(final Show<A> sa, final Show<B> sb, final Show<C> sc) {
    return new Show<P3<A, B, C>>(new Func<P3<A, B, C>, Stream<Character>>() {
  ...
  public static <A, B, C, D> Show<P4<A, B, C, D>> p4Show(final Show<A> sa, final Show<B> sb,
    ...
    return new Show<P4<A, B, C, D>>(new Func<P4<A, B, C, D>, Stream<Character>>() {
  ...
  public static <A, B, C, D, E> Show<P5<A, B, C, D, E>> p5Show(final Show<A> sa, final Show<B> sb,
    ...
    return new Show<P5<A, B, C, D, E>>(new Func<P5<A, B, C, D, E>, Stream<Character>>() {
  ...
  public static <A, B, C, D, E, F$> Show<P6<A, B, C, D, E, F$>> p6Show(final Show<A> sa, final Show<B> sb,
    ...
    return new Show<P6<A, B, C, D, E, F$>>(new Func<P6<A, B, C, D, E, F$>, Stream<Character>>() {
  ...
  public static <A, B, C, D, E, F$, G> Show<P7<A, B, C, D, E, F$, G>> p7Show(final Show<A> sa, final Show<B> sb,
                                                                             ...
                                                                             final Show<E> se, final Show<F$> sf,
                                                                             final Show<G> sg) {
    return new Show<P7<A, B, C, D, E, F$, G>>(new Func<P7<A, B, C, D, E, F$, G>, Stream<Character>>() {
  ...
  public static <A, B, C, D, E, F$, G, H> Show<P8<A, B, C, D, E, F$, G, H>> p8Show(final Show<A> sa, final Show<B> sb,
    ...
    return new Show<P8<A, B, C, D, E, F$, G, H>>(new Func<P8<A, B, C, D, E, F$, G, H>, Stream<Character>>() {
   ...
   */
  public static final Show<Natural> naturalShow = bigintShow.comap(new Func<Natural, BigInteger>() {
   ...
   */
  public static final Show<LazyString> lazyStringShow = show(new Func<LazyString, Stream<Character>>() {
  ...
  public static <E, L extends HList<L>> Show<HList.HCons<E, L>> HListShow(final Show<E> e, final Show<L> l) {
    return show(new Func<HList.HCons<E, L>, Stream<Character>>() {
