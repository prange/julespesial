...
public final class Variant {
  ...
  public static <A> Gen<A> variant(final long n, final Gen<A> g) {
    ...
    if(gx == null) {
      final Gen<A> t = gen(new Func<Integer, Func<Rand, A>>() {
      ...
      variantMemo.put(p, t);
      return t;
    } else return gen(new Func<Integer, Func<Rand, A>>() {
      public Func<Rand, A> f(final Integer i) {
        return new Func<Rand, A>() {
  ...
  /**
   * A curried version of {@link #variant(long, fj.test.Gen)}.
   *
   * @param n The value to produce the new generator from.
   * @return A curried version of {@link #variant(long, fj.test.Gen)}.
   */
  public static <A> Func<Gen<A>, Gen<A>> variant(final long n) {
    return new Func<Gen<A>, Gen<A>>() {
