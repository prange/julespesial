 ...
 * returns an {@link fj.data.Option optional value} of the type parameter. Several generators are provided,
 ...
 * invoking the {@link #bind(Func)}  methods &mdash; in this case, {@link #bind(fj.test.Gen , fj.test.Gen , Func)} the one
...
public final class Gen<A> {
  private final Func<Integer, Func<Rand, A>> f;

  private Gen(final Func<Integer, Func<Rand, A>> f) {
    this.f = f;
  }
   ...
   */
  public <B> Gen<B> map(final Func<A, B> f) {
    return new Gen<B>(new Func<Integer, Func<Rand, B>>() {
      public Func<Rand, B> f(final Integer i) {
        return new Func<Rand, B>() {
   ...
   */
  public Gen<A> filter(final Func<A, Boolean> f) {
    return gen(Function.curry(new Func2<Integer, Rand, A>() {
   ...
   */
  public Unit foreach(final Integer i, final Rand r, final Func<A, Unit> f) {
   ...
   */
  public <B> Gen<B> bind(final Func<A, Gen<B>> f) {
    return new Gen<B>(new Func<Integer, Func<Rand, B>>() {
      public Func<Rand, B> f(final Integer i) {
        return new Func<Rand, B>() {
          public B f(final Rand r) {
   ...
   * @return A new generator after binding the given function.
   */
  public <B, C> Gen<C> bind(final Gen<B> gb, final Func<A, Func<B, C>> f) {
   ...
   * @return A new generator after binding the given function.
   */
  public <B, C, D> Gen<D> bind(final Gen<B> gb, final Gen<C> gc, final Func<A, Func<B, Func<C, D>>> f) {
   ...
   * @return A new generator after binding the given function.
   */
  public <B, C, D, E> Gen<E> bind(final Gen<B> gb, final Gen<C> gc, final Gen<D> gd, final Func<A, Func<B, Func<C, Func<D, E>>>> f) {
   ...
   * @return A new generator after binding the given function.
   */
  public <B, C, D, E, F$> Gen<F$> bind(final Gen<B> gb, final Gen<C> gc, final Gen<D> gd, final Gen<E> ge, final Func<A, Func<B, Func<C, Func<D, Func<E, F$>>>>> f) {
   ...
   * @return A new generator after binding the given function.
   */
  public <B, C, D, E, F$, G> Gen<G> bind(final Gen<B> gb, final Gen<C> gc, final Gen<D> gd, final Gen<E> ge, final Gen<F$> gf, final Func<A, Func<B, Func<C, Func<D, Func<E, Func<F$, G>>>>>> f) {
   ...
   * @return A new generator after binding the given function.
   */
  public <B, C, D, E, F$, G, H> Gen<H> bind(final Gen<B> gb, final Gen<C> gc, final Gen<D> gd, final Gen<E> ge, final Gen<F$> gf, final Gen<G> gg, final Func<A, Func<B, Func<C, Func<D, Func<E, Func<F$, Func<G, H>>>>>>> f) {
   ...
   * @return A new generator after binding the given function.
   */
  public <B, C, D, E, F$, G, H, I> Gen<I> bind(final Gen<B> gb, final Gen<C> gc, final Gen<D> gd, final Gen<E> ge, final Gen<F$> gf, final Gen<G> gg, final Gen<H> gh, final Func<A, Func<B, Func<C, Func<D, Func<E, Func<F$, Func<G, Func<H, I>>>>>>>> f) {
   ...
   */
  public <B> Gen<B> apply(final Gen<Func<A, B>> gf) {
    return gf.bind(new Func<Func<A, B>, Gen<B>>() {
      public Gen<B> f(final Func<A, B> f) {
  ...
  public Gen<A> resize(final int s) {
    return new Gen<A>(new Func<Integer, Func<Rand, A>>() {
      public Func<Rand, A> f(final Integer i) {
        return new Func<Rand, A>() {
   ...
   */
  public static <A> Gen<A> gen(final Func<Integer, Func<Rand, A>> f) {
    return new Gen<A>(f);
  }

  /**
   * Sequence the given generators through a {@link #bind(Func)} operation.
   *
  ...
  public static <A> Gen<List<A>> sequence(final List<Gen<A>> gs) {
    return gs.foldRight(new Func<Gen<A>, Func<Gen<List<A>>, Gen<List<A>>>>() {
      public Func<Gen<List<A>>, Gen<List<A>>> f(final Gen<A> ga) {
        return new Func<Gen<List<A>>, Gen<List<A>>>() {
  ...
  /**
   * Sequences the given generator the given number of times through a {@link #bind(Func)} operation.
   *
   ...
   */
  public static <A> Gen<A> parameterised(final Func<Integer, Func<Rand, Gen<A>>> f) {
    return new Gen<A>(Function.curry(new Func2<Integer, Rand, A>() {
      public A f(final Integer i, final Rand r) {
   ...
   * @return A new generator.
   */
  public static <A> Gen<A> sized(final Func<Integer, Gen<A>> f) {
    return parameterised(flip(Function.<Rand, Func<Integer, Gen<A>>>constant(f)));
  }
  ...
  public static Gen<Integer> choose(final int from, final int to) {
    ...
    return parameterised(Function.curry(new Func2<Integer, Rand, Gen<Integer>>() {
  ...
  public static Gen<Double> choose(final double from, final double to) {
    ...
    return parameterised(new Func<Integer, Func<Rand, Gen<Double>>>() {
      public Func<Rand, Gen<Double>> f(final Integer i) {
        return new Func<Rand, Gen<Double>>() {
  ...
  /**
   * Joins the generator of generators through a {@link #bind(Func)} operation.
   *
  ...
  public static <A> Gen<A> frequency(final List<P2<Integer, Gen<A>>> gs) {
    ...
    final Func<P2<Integer, Gen<A>>, Integer> f = __1();

    return choose(1, intAdditionMonoid.sumLeft(gs.map(f))).bind(new Func<Integer, Gen<A>>() {
  ...
  public static <A> Gen<A> elemFrequency(final List<P2<Integer, A>> as) {
    return frequency(as.map(new Func<P2<Integer, A>, P2<Integer, Gen<A>>>() {
      public P2<Integer, Gen<A>> f(final P2<Integer, A> p) {
        return p.map2(new Func<A, Gen<A>>() {
  ...
  public static <A> Gen<A> elements(final A... as) {
    return array(as).isEmpty() ? Gen.<A>fail() : choose(0, as.length - 1).map(new Func<Integer, A>() {
  ...
  public static <A> Gen<A> oneOf(final List<Gen<A>> gs) {
    return gs.isEmpty() ? Gen.<A>fail() : choose(0, gs.length() - 1).bind(new Func<Integer, Gen<A>>() {
      public Gen<A> f(final Integer i) {
        return gs.index(i);
      }
    });
  ...
  public static <A> Gen<List<A>> listOf(final Gen<A> g, final int x) {
    return sized(new Func<Integer, Gen<List<A>>>() {
      public Gen<List<A>> f(final Integer size) {
        return choose(x, size).bind(new Func<Integer, Gen<List<A>>>() {
  ...
  public static <A> Gen<List<A>> pick(final int n, final List<A> as) {
    return n < 0 || n > as.length() ? Gen.<List<A>>fail() : sequenceN(n, choose(0, as.length() - 1)).map(new Func<List<Integer>, List<A>>() {
  ...
  public static <A> Gen<List<A>> someOf(final List<A> as) {
    return choose(0, as.length()).bind(new Func<Integer, Gen<List<A>>>() {
   ...
   */
  public static <A, B> Gen<Func<A, B>> promote(final Func<A, Gen<B>> f) {
    return new Gen<Func<A, B>>(new Func<Integer, Func<Rand, Func<A, B>>>() {
      public Func<Rand, Func<A, B>> f(final Integer i) {
        return new Func<Rand, Func<A, B>>() {
          public Func<A, B> f(final Rand r) {
            return new Func<A, B>() {
              public B f(final A a) {
