...
public abstract class Trampoline<A> {
  ...
  private static abstract class Normal<A> extends Trampoline<A> {
    public abstract <R> R foldNormal(final Func<A, R> pure, final Func<P1<Trampoline<A>>, R> k);

    public <B> Trampoline<B> bind(final Func<A, Trampoline<B>> f) {
  ...
  private static final class Codense<A> extends Trampoline<A> {
    ...
    private final Func<Object, Trampoline<A>> cont;

    private Codense(final Normal<Object> t, final Func<Object, Trampoline<A>> k) {
      sub = t;
      cont = k;
    }

    public <R> R fold(final Func<Normal<A>, R> n,
                      final Func<Codense<A>, R> gs) {
      return gs.f(this);
    }
    ...
    // continuations.
    public <B> Trampoline<B> bind(final Func<A, Trampoline<B>> f) {
      return codense(sub, new Func<Object, Trampoline<B>>() {
    ...
    public Either<P1<Trampoline<A>>, A> resume() {
      return left(sub.resume().either(new Func<P1<Trampoline<Object>>, P1<Trampoline<A>>>() {
            public P1<Trampoline<A>> f(final P1<Trampoline<Object>> p) {
              return p.map(new Func<Trampoline<Object>, Trampoline<A>>() {
                public Trampoline<A> f(final Trampoline<Object> ot) {
                  return ot.fold(new Func<Normal<Object>, Trampoline<A>>() {
                        public Trampoline<A> f(final Normal<Object> o) {
                          return o.foldNormal(new Func<Object, Trampoline<A>>() {
                                public Trampoline<A> f(final Object o) {
                                  return cont.f(o);
                                }
                              }, new Func<P1<Trampoline<Object>>, Trampoline<A>>() {
                      ...
                      }, new Func<Codense<Object>, Trampoline<A>>() {
                    public Trampoline<A> f(final Codense<Object> c) {
                      return codense(c.sub, new Func<Object, Trampoline<A>>() {
                        public Trampoline<A> f(final Object o) {
          ...
          }, new Func<Object, P1<Trampoline<A>>>() {
  ...
  private static final class Suspend<A> extends Normal<A> {
    ...
    public <R> R foldNormal(final Func<A, R> pure, final Func<P1<Trampoline<A>>, R> k) {
      return k.f(suspension);
    }

    public <R> R fold(final Func<Normal<A>, R> n, final Func<Codense<A>, R> gs) {
      return n.f(this);
    }
  ...
  protected static <A, B> Codense<B> codense(final Normal<A> a, final Func<A, Trampoline<B>> k) {
    return new Codense<B>((Normal<Object>) a, (Func<Object, Trampoline<B>>) k);
  }

  /**
   * @return The first-class version of `pure`.
   */
  public static <A> Func<A, Trampoline<A>> pure() {
    return new Func<A, Trampoline<A>>() {
   ...
   */
  public static <A> Func<P1<Trampoline<A>>, Trampoline<A>> suspend_() {
    return new Func<P1<Trampoline<A>>, Trampoline<A>>() {
  ...
  protected abstract <R> R fold(final Func<Normal<A>, R> n, final Func<Codense<A>, R> gs);
   ...
   */
  public abstract <B> Trampoline<B> bind(final Func<A, Trampoline<B>> f);
   ...
   */
  public final <B> Trampoline<B> map(final Func<A, B> f) {
   ...
   */
  public static <A, B> Func<Func<A, Trampoline<B>>, Func<Trampoline<A>, Trampoline<B>>> bind_() {
    return new Func<Func<A, Trampoline<B>>, Func<Trampoline<A>, Trampoline<B>>>() {
      public Func<Trampoline<A>, Trampoline<B>> f(final Func<A, Trampoline<B>> f) {
        return new Func<Trampoline<A>, Trampoline<B>>() {
   ...
   */
  public static <A, B> Func<Func<A, B>, Func<Trampoline<A>, Trampoline<B>>> map_() {
    return new Func<Func<A, B>, Func<Trampoline<A>, Trampoline<B>>>() {
      public Func<Trampoline<A>, Trampoline<B>> f(final Func<A, B> f) {
        return new Func<Trampoline<A>, Trampoline<B>>() {
          public Trampoline<B> f(final Trampoline<A> a) {
            return a.map(f);
          }
   ...
   */
  public static <A> Func<Trampoline<A>, Either<P1<Trampoline<A>>, A>> resume_() {
    return new Func<Trampoline<A>, Either<P1<Trampoline<A>>, A>>() {
   ...
   */
  public final <B> Trampoline<B> apply(final Trampoline<Func<A, B>> lf) {
    return lf.bind(new Func<Func<A, B>, Trampoline<B>>() {
      public Trampoline<B> f(final Func<A, B> f) {
        return map(f);
      }
    });
  }
   ...
   */
  public final <B, C> Trampoline<C> bind(final Trampoline<B> lb, final Func<A, Func<B, C>> f) {
   ...
   */
  public static <A, B, C> Func<Trampoline<A>, Func<Trampoline<B>, Trampoline<C>>> liftM2(final Func<A, Func<B, C>> f) {
    return curry(new Func2<Trampoline<A>, Trampoline<B>, Trampoline<C>>() {
   ...
   */
  @SuppressWarnings("LoopStatementThatDoesntLoop")
  public <B, C> Trampoline<C> zipWith(final Trampoline<B> b, final Func2<A, B, C> f) {
    ...
    for (final P1<Trampoline<A>> x : ea.left()) {
      for (final P1<Trampoline<B>> y : eb.left()) {
        return suspend(P1.bind(x, y, new Func2<Trampoline<A>, Trampoline<B>, Trampoline<C>>() {
      ...
      for (final B y : eb.right()) {
        return suspend(x.map(new Func<Trampoline<A>, Trampoline<C>>() {
