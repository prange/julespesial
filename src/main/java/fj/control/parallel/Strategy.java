...
public final class Strategy<A> {
  ...
  private final Func<P1<A>, P1<A>> f;

  private Strategy(final Func<P1<A>, P1<A>> f) {
    this.f = f;
  }
   ...
   */
  public static <A> Strategy<A> strategy(final Func<P1<A>, P1<A>> f) {
   ...
   */
  public <B> Func<B, P1<A>> concurry(final Func<B, A> f) {
   ...
   */
  public <B, C> Func<B, Func<C, P1<A>>> concurry(final Func2<B, C, A> f) {
    return new Func<B, Func<C, P1<A>>>() {
      public Func<C, P1<A>> f(final B b) {
   ...
   */
  public <B> P1<List<A>> parMap(final Func<B, A> f, final List<B> bs) {
   ...
   */
  public <B> P1<Array<A>> parMap(final Func<B, A> f, final Array<B> bs) {
    return sequence(bs.map(concurry(f)));
  }
   ...
   */
  public <B> List<A> parMap1(final Func<B, A> f, final List<B> bs) {
   ...
   */
  public <B> Array<A> parMap1(final Func<B, A> f, final Array<B> bs) {
   ...
   */
  public <B> Func<List<B>, P1<List<A>>> parMapList(final Func<B, A> f) {
    return new Func<List<B>, P1<List<A>>>() {
   ...
   */
  public <B> Func<Func<B, A>, Func<List<B>, P1<List<A>>>> parMapList() {
    return new Func<Func<B, A>, Func<List<B>, P1<List<A>>>>() {
      public Func<List<B>, P1<List<A>>> f(final Func<B, A> f) {
        return parMapList(f);
      }
    };
  }
   ...
   */
  public <B> Func<Func<B, A>, Func<List<B>, List<A>>> parMapList1() {
    return new Func<Func<B, A>, Func<List<B>, List<A>>>() {
      public Func<List<B>, List<A>> f(final Func<B, A> f) {
        return new Func<List<B>, List<A>>() {
   ...
   */
  public <B> Func<Array<B>, P1<Array<A>>> parMapArray(final Func<B, A> f) {
    return new Func<Array<B>, P1<Array<A>>>() {
   ...
   */
  public <B> Func<Func<B, A>, Func<Array<B>, P1<Array<A>>>> parMapArray() {
    return new Func<Func<B, A>, Func<Array<B>, P1<Array<A>>>>() {
      public Func<Array<B>, P1<Array<A>>> f(final Func<B, A> f) {
   ...
   */
  public <B> Func<Func<B, A>, Func<Array<B>, Array<A>>> parMapArray1() {
    return new Func<Func<B, A>, Func<Array<B>, Array<A>>>() {
      public Func<Array<B>, Array<A>> f(final Func<B, A> f) {
        return new Func<Array<B>, Array<A>>() {
   ...
   */
  public <B, C> P1<List<A>> parZipWith(final Func2<B, C, A> f, final List<B> bs, final List<C> cs) {
   ...
   */
  public <B, C> P1<Array<A>> parZipWith(final Func2<B, C, A> f, final Array<B> bs, final Array<C> cs) {
    return sequence(bs.zipWith(cs, concurry(f)));
  }
   ...
   */
  public <B, C> Func2<List<B>, List<C>, P1<List<A>>> parZipListWith(final Func2<B, C, A> f) {
    return new Func2<List<B>, List<C>, P1<List<A>>>() {
   ...
   */
  public <B, C> Func2<Array<B>, Array<C>, P1<Array<A>>> parZipArrayWith(final Func2<B, C, A> f) {
    return new Func2<Array<B>, Array<C>, P1<Array<A>>>() {
   ...
   */
  public static <A> Func<Future<A>, P1<A>> obtain() {
    return new Func<Future<A>, P1<A>>() {
  ...
  public static <A> Strategy<A> simpleThreadStrategy() {
    return strategy(new Func<P1<A>, P1<A>>() {
   ...
   */
  public <B> Strategy<B> xmap(final Func<P1<A>, P1<B>> f, final Func<P1<B>, P1<A>> g) {
   ...
   */
  public Strategy<A> map(final Func<P1<A>, P1<A>> f) {
   ...
   */
  public Strategy<A> comap(final Func<P1<A>, P1<A>> f) {
  ...
  public static <A> Strategy<A> errorStrategy(final Strategy<A> s, final Effect<Error> e) {
    return s.comap(new Func<P1<A>, P1<A>>() {
      public P1<A> f(final P1<A> a) {
        return new P1<A>() {
          public A _1() {
            try {
  ...
  public static <A> Strategy<Callable<A>> callableStrategy(final Strategy<Callable<A>> s) {
    return s.comap(new Func<P1<Callable<A>>, P1<Callable<A>>>() {
