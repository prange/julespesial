...
public final class ParModule {
   ...
   */
  public <A> Func<P1<A>, Promise<A>> promise() {
    return new Func<P1<A>, Promise<A>>() {
   ...
   */
  public <A, B> Func<A, Promise<B>> promise(final Func<A, B> f) {
   ...
   */
  public <A, B> Func<Func<A, B>, Func<A, Promise<B>>> promisePure() {
    return new Func<Func<A, B>, Func<A, Promise<B>>>() {
      public Func<A, Promise<B>> f(final Func<A, B> abf) {
        return promise(abf);
      }
    };
  }
   ...
   *         that can be claimed in the future.
   */
  public <A, B, C> Func2<A, B, Promise<C>> promise(final Func2<A, B, C> f) {
   ...
   */
  public <A> Func<Effect<A>, Actor<A>> effect() {
    return new Func<Effect<A>, Actor<A>>() {
   ...
   */
  public <A> Func<Effect<A>, Actor<A>> actor() {
    return new Func<Effect<A>, Actor<A>>() {
      public Actor<A> f(final Effect<A> effect) {
        return actor(effect);
      }
   ...
   */
  public <A> Func<List<Promise<A>>, Promise<List<A>>> sequenceList() {
    return new Func<List<Promise<A>>, Promise<List<A>>>() {
   ...
   */
  public <A> Func<Stream<Promise<A>>, Promise<Stream<A>>> sequenceStream() {
    return new Func<Stream<Promise<A>>, Promise<Stream<A>>>() {
   ...
   */
  public <A, B> Promise<List<B>> mapM(final List<A> as, final Func<A, Promise<B>> f) {
   ...
   */
  public <A, B> Func<Func<A, Promise<B>>, Func<List<A>, Promise<List<B>>>> mapList() {
    return curry(new Func2<Func<A, Promise<B>>, List<A>, Promise<List<B>>>() {
      public Promise<List<B>> f(final Func<A, Promise<B>> f, final List<A> list) {
        return mapM(list, f);
      }
    });
  }
   ...
   */
  public <A, B> Promise<Stream<B>> mapM(final Stream<A> as, final Func<A, Promise<B>> f) {
    return sequence(as.map(f));
  }
   ...
   */
  public <A, B> Func<Func<A, Promise<B>>, Func<Stream<A>, Promise<Stream<B>>>> mapStream() {
    return curry(new Func2<Func<A, Promise<B>>, Stream<A>, Promise<Stream<B>>>() {
      public Promise<Stream<B>> f(final Func<A, Promise<B>> f, final Stream<A> stream) {
   ...
   */
  public <A, B> Promise<P1<B>> mapM(final P1<A> a, final Func<A, Promise<B>> f) {
   ...
   * @return A Promise of a new list with the given function applied to each element.
   */
  public <A, B> Promise<List<B>> parMap(final List<A> as, final Func<A, B> f) {
   ...
   */
  public <A, B> Func<Func<A, B>, Func<List<A>, Promise<List<B>>>> parMapList() {
    return curry(new Func2<Func<A, B>, List<A>, Promise<List<B>>>() {
      public Promise<List<B>> f(final Func<A, B> abf, final List<A> list) {
   ...
   */
  public <A, B> Promise<NonEmptyList<B>> parMap(final NonEmptyList<A> as, final Func<A, B> f) {
    return mapM(as.toList(), promise(f)).fmap(new Func<List<B>, NonEmptyList<B>>() {
   ...
   * @return A Promise of a new Stream with the given function applied to each element.
   */
  public <A, B> Promise<Stream<B>> parMap(final Stream<A> as, final Func<A, B> f) {
    return mapM(as, promise(f));
  }
   ...
   */
  public <A, B> Func<Func<A, B>, Func<Stream<A>, Promise<Stream<B>>>> parMapStream() {
    return curry(new Func2<Func<A, B>, Stream<A>, Promise<Stream<B>>>() {
      public Promise<Stream<B>> f(final Func<A, B> abf, final Stream<A> stream) {
   ...
   */
  public <A, B> Promise<Iterable<B>> parMap(final Iterable<A> as, final Func<A, B> f) {
   ...
   */
  public <A, B> Func<Func<A, B>, Func<Iterable<A>, Promise<Iterable<B>>>> parMapIterable() {
    return curry(new Func2<Func<A, B>, Iterable<A>, Promise<Iterable<B>>>() {
      public Promise<Iterable<B>> f(final Func<A, B> abf, final Iterable<A> iterable) {
   ...
   */
  public <A, B> Promise<Array<B>> parMap(final Array<A> as, final Func<A, B> f) {
    return parMap(as.toStream(), f).fmap(new Func<Stream<B>, Array<B>>() {
   ...
   */
  public <A, B> Func<Func<A, B>, Func<Array<A>, Promise<Array<B>>>> parMapArray() {
    return curry(new Func2<Func<A, B>, Array<A>, Promise<Array<B>>>() {
      public Promise<Array<B>> f(final Func<A, B> abf, final Array<A> array) {
   ...
   */
  public <A, B> Promise<Zipper<B>> parMap(final Zipper<A> za, final Func<A, B> f) {
   ...
   */
  public <A, B> Promise<Tree<B>> parMap(final Tree<A> ta, final Func<A, B> f) {
   ...
   */
  public <A, B> Func<Func<A, B>, Func<Tree<A>, Promise<Tree<B>>>> parMapTree() {
    return curry(new Func2<Func<A, B>, Tree<A>, Promise<Tree<B>>>() {
      public Promise<Tree<B>> f(final Func<A, B> abf, final Tree<A> tree) {
   ...
   */
  public <A, B> Promise<TreeZipper<B>> parMap(final TreeZipper<A> za, final Func<A, B> f) {
    final Func<Tree<A>, Tree<B>> tf = Tree.<A, B>fmap_().f(f);
    final P4<Tree<A>, Stream<Tree<A>>, Stream<Tree<A>>, Stream<P3<Stream<Tree<A>>, A, Stream<Tree<A>>>>> p = za.p();
    return mapM(p._4(),
                new Func<P3<Stream<Tree<A>>, A, Stream<Tree<A>>>, Promise<P3<Stream<Tree<B>>, B, Stream<Tree<B>>>>>() {
   ...
   */
  public <A, B> Promise<List<B>> parFlatMap(final List<A> as, final Func<A, List<B>> f) {
   ...
   */
  public <A, B> Promise<Stream<B>> parFlatMap(final Stream<A> as, final Func<A, Stream<B>> f) {
   ...
   */
  public <A, B> Promise<Array<B>> parFlatMap(final Array<A> as, final Func<A, Array<B>> f) {
   ...
   */
  public <A, B> Promise<Iterable<B>> parFlatMap(final Iterable<A> as, final Func<A, Iterable<B>> f) {
   ...
   */
  public <A, B, C> Promise<List<C>> parZipWith(final List<A> as, final List<B> bs, final Func<A, Func<B, C>> f) {
   ...
   */
  public <A, B, C> Promise<Stream<C>> parZipWith(final Stream<A> as, final Stream<B> bs, final Func<A, Func<B, C>> f) {
    return sequence(as.<B, Promise<C>>zipWith(bs, promise(uncurryF2(f))));
  }
   ...
   */
  public <A, B, C> Promise<Array<C>> parZipWith(final Array<A> as, final Array<B> bs, final Func<A, Func<B, C>> f) {
    return parZipWith(as.toStream(), bs.toStream(), f).fmap(new Func<Stream<C>, Array<C>>() {
   ...
   */
  public <A, B, C> Promise<Iterable<C>> parZipWith(final Iterable<A> as, final Iterable<B> bs, final Func<A, Func<B, C>> f) {
   ...
   */
  public <A, B> Promise<B> parFoldMap(final Stream<A> as, final Func<A, B> map, final Monoid<B> reduce) {
   ...
   */
  public <A, B> Promise<B> parFoldMap(final Stream<A> as, final Func<A, B> map, final Monoid<B> reduce,
                                      final Func<Stream<A>, P2<Stream<A>, Stream<A>>> chunking) {
    return parMap(Stream.unfold(new Func<Stream<A>, Option<P2<Stream<A>, Stream<A>>>>() {
    ...
    }, as), Stream.<A, B>map_().f(map)).bind(new Func<Stream<Stream<B>>, Promise<B>>() {
   ...
   * @return A promise of a result of mapping and folding in parallel.
   */
  public <A, B> Promise<B> parFoldMap(final Iterable<A> as, final Func<A, B> map, final Monoid<B> reduce,
                                      final Func<Iterable<A>, P2<Iterable<A>, Iterable<A>>> chunking) {
    return parFoldMap(iterableStream(as), map, reduce, new Func<Stream<A>, P2<Stream<A>, Stream<A>>>() {
      public P2<Stream<A>, Stream<A>> f(final Stream<A> stream) {
        final Func<Iterable<A>, Stream<A>> is = new Func<Iterable<A>, Stream<A>>() {
   ...
   *         zipper.
   */
  public <A, B> Promise<Zipper<B>> parExtend(final Zipper<A> za, final Func<Zipper<A>, B> f) {
   ...
   */
  public <A, B> Promise<Tree<B>> parExtend(final Tree<A> ta, final Func<Tree<A>, B> f) {
   ...
   *         given TreeZipper.
   */
  public <A, B> Promise<TreeZipper<B>> parExtend(final TreeZipper<A> za, final Func<TreeZipper<A>, B> f) {
    return parMap(za.positions(), f);
  }
   ...
   *         given NonEmptyList.
   */
  public <A, B> Promise<NonEmptyList<B>> parExtend(final NonEmptyList<A> as, final Func<NonEmptyList<A>, B> f) {
