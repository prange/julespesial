...
public final class Callables {
   ...
   */
  public static <A> Func<A, Callable<A>> callable() {
    return new Func<A, Callable<A>>() {
   ...
   */
  public static <A, B> Func<A, Callable<B>> callable(final Func<A, B> f) {
    return new Func<A, Callable<B>>() {
   ...
   */
  public static <A, B> Func<Func<A, B>, Func<A, Callable<B>>> arrow() {
    return new Func<Func<A, B>, Func<A, Callable<B>>>() {
      public Func<A, Callable<B>> f(final Func<A, B> f) {
        return callable(f);
      }
    };
  }
   ...
   */
  public static <A, B> Callable<B> bind(final Callable<A> a, final Func<A, Callable<B>> f) {
    return new Callable<B>() {
   ...
   */
  public static <A, B> Func<Callable<A>, Callable<B>> fmap(final Func<A, B> f) {
    return new Func<Callable<A>, Callable<B>>() {
   ...
   */
  public static <A, B> Callable<B> apply(final Callable<A> ca, final Callable<Func<A, B>> cf) {
    return bind(cf, new Func<Func<A, B>, Callable<B>>() {
      public Callable<B> f(final Func<A, B> f) {
        return fmap(f).f(ca);
      }
    });
  }
   ...
   */
  public static <A, B, C> Callable<C> bind(final Callable<A> ca, final Callable<B> cb, final Func<A, Func<B, C>> f) {
   ...
   */
  public static <A, B, C> Func<Callable<A>, Func<Callable<B>, Callable<C>>> liftM2(final Func<A, Func<B, C>> f) {
    return curry(new Func2<Callable<A>, Callable<B>, Callable<C>>() {
   ...
   */
  public static <A> Func<List<Callable<A>>, Callable<List<A>>> sequence_() {
    return new Func<List<Callable<A>>, Callable<List<A>>>() {
   ...
   */
  public static <A> Func<Callable<A>, P1<Option<A>>> option() {
    return new Func<Callable<A>, P1<Option<A>>>() {
   ...
   */
  public static <A> Func<Callable<A>, P1<Either<Exception, A>>> either() {
    return new Func<Callable<A>, P1<Either<Exception, A>>>() {
   ...
   */
  public static <A> Func<P1<Either<Exception, A>>, Callable<A>> fromEither() {
    return new Func<P1<Either<Exception, A>>, Callable<A>>() {
   ...
   */
  public static <A> Func<P1<Option<A>>, Callable<A>> fromOption() {
    return new Func<P1<Option<A>>, Callable<A>>() {
   ...
   */
  public static <A> Func<Callable<A>, Callable<A>> normalise() {
    return new Func<Callable<A>, Callable<A>>() {
