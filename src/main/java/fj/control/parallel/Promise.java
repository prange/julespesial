...
public final class Promise<A> {
   ...
   */
  public static <A> Func<P1<A>, Promise<A>> promise(final Strategy<Unit> s) {
   ...
   */
  public static <A, B> Func<A, Promise<B>> promise(final Strategy<Unit> s, final Func<A, B> f) {
    return new Func<A, Promise<B>>() {
   ...
   */
  public <B> Promise<B> fmap(final Func<A, B> f) {
   ...
   */
  public static <A, B> Func<Promise<A>, Promise<B>> fmap_(final Func<A, B> f) {
  ...
  public static <A> Promise<A> join(final Promise<Promise<A>> p) {
    final Func<Promise<A>, Promise<A>> id = identity();
    return p.bind(id);
  }
   ...
   */
  public <B> Promise<B> bind(final Func<A, Promise<B>> f) {
   ...
   */
  public <B> Promise<B> apply(final Promise<Func<A, B>> pf) {
    return pf.bind(new Func<Func<A, B>, Promise<B>>() {
      public Promise<B> f(final Func<A, B> f) {
        return fmap(f);
      }
    });
  }
   ...
   */
  public <B, C> Promise<C> bind(final Promise<B> pb, final Func<A, Func<B, C>> f) {
   ...
   * @return A new promise after performing the map, then final join.
   */
  public <B, C> Promise<C> bind(final P1<Promise<B>> p, final Func<A, Func<B, C>> f) {
   ...
   */
  public static <A, B, C> Func<Promise<A>, Func<Promise<B>, Promise<C>>> liftM2(final Func<A, Func<B, C>> f) {
    return curry(new Func2<Promise<A>, Promise<B>, Promise<C>>() {
   ...
   */
  public static <A> Func<List<Promise<A>>, Promise<List<A>>> sequence(final Strategy<Unit> s) {
  ...
  public static <A> Promise<Stream<A>> sequence(final Strategy<Unit> s, final Stream<Promise<A>> as) {
    return join(foldRightS(s, curry(new Func2<Promise<A>, P1<Promise<Stream<A>>>, Promise<Stream<A>>>() {
      public Promise<Stream<A>> f(final Promise<A> o, final P1<Promise<Stream<A>>> p) {
        return o.bind(new Func<A, Promise<Stream<A>>>() {
   ...
   */
  public static <A> Func<List<Promise<A>>, Promise<List<A>>> sequenceS(final Strategy<Unit> s) {
    return new Func<List<Promise<A>>, Promise<List<A>>>() {
      public Promise<List<A>> f(final List<Promise<A>> as) {
        return sequence(s, as);
      }
   ...
   */
  public static <A, B> Func<List<A>, Promise<B>> foldRight(final Strategy<Unit> s, final Func<A, Func<B, B>> f, final B b) {
    return new Func<List<A>, Promise<B>>() {
   ...
   * @return The final result after the right-fold reduction.
   */
  public static <A, B> Func<Stream<A>, Promise<B>> foldRightS(final Strategy<Unit> s, final Func<A, Func<P1<B>, B>> f,
                                                           final B b) {
    return new Func<Stream<A>, Promise<B>>() {
   ...
   */
  public <B> Promise<B> cobind(final Func<Promise<A>, B> f) {
   ...
   */
  public <B> Stream<B> sequenceW(final Stream<Func<Promise<A>, B>> fs) {
    return fs.isEmpty()
           ? Stream.<B>nil()
