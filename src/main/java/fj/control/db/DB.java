...
public abstract class DB<A> {
   ...
   */
  public static <A> DB<A> db(final Func<Connection, A> f) {
    return new DB<A>() {
   ...
   */
  public final Func<Connection, Callable<A>> asFunction() {
    return new Func<Connection, Callable<A>>() {
   ...
   */
  public final <B> DB<B> map(final Func<A, B> f) {
    return new DB<B>() {
   ...
   */
  public static <A, B> Func<DB<A>, DB<B>> liftM(final Func<A, B> f) {
    return new Func<DB<A>, DB<B>>() {
   ...
   */
  public final <B> DB<B> bind(final Func<A, DB<B>> f) {
    return new DB<B>() {
      public B run(final Connection c) throws SQLException {
