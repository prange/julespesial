...
public abstract class P4<A, B, C, D> {
   ...
   */
  public final <X> P4<X, B, C, D> map1(final Func<A, X> f) {
   ...
   * @return A product with the given function applied.
   */
  public final <X> P4<A, X, C, D> map2(final Func<B, X> f) {
   ...
   * @return A product with the given function applied.
   */
  public final <X> P4<A, B, X, D> map3(final Func<C, X> f) {
   ...
   * @return A product with the given function applied.
   */
  public final <X> P4<A, B, C, X> map4(final Func<D, X> f) {
   ...
   */
  public static <A, B, C, D> Func<P4<A, B, C, D>, A> __1() {
    return new Func<P4<A, B, C, D>, A>() {
   ...
   */
  public static <A, B, C, D> Func<P4<A, B, C, D>, B> __2() {
    return new Func<P4<A, B, C, D>, B>() {
   ...
   */
  public static <A, B, C, D> Func<P4<A, B, C, D>, C> __3() {
    return new Func<P4<A, B, C, D>, C>() {
   ...
   */
  public static <A, B, C, D> Func<P4<A, B, C, D>, D> __4() {
    return new Func<P4<A, B, C, D>, D>() {
