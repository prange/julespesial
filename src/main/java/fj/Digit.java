...
public enum Digit {
   ...
   */
  public static final Func<Digit, Long> toLong = new Func<Digit, Long>() {
   ...
   */
  public static final Func<Long, Digit> fromLong = new Func<Long, Digit>() {
   ...
   */
  public static final Func<Digit, Character> toChar = new Func<Digit, Character>() {
   ...
   */
  public static final Func<Character, Option<Digit>> fromChar = new Func<Character, Option<Digit>>() {
