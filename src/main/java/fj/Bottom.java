...
public final class Bottom {
   ...
   */
  public static <A, B> Func<A, B> errorF(final String s) {
    return new Func<A, B>() {
   ...
   */
  public static <T extends Throwable> Func<T, String> eToString() {
   ...
   */
  public static <T extends Throwable> Func<T, String> eMessage() {
    return new Func<T, String>() {
      public String f(final Throwable t) {
        return t.getMessage();
      }
