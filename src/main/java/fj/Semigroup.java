...
public final class Semigroup<A> {
  private final Func<A, Func<A, A>> sum;

  private Semigroup(final Func<A, Func<A, A>> sum) {
    this.sum = sum;
  }
   ...
   */
  public Func<A, A> sum(final A a1) {
    return sum.f(a1);
  }
   ...
   */
  public static <A> Semigroup<A> semigroup(final Func<A, Func<A, A>> sum) {
   ...
   * @return A semigroup from the given function.
   */
  public static <A> Semigroup<A> semigroup(final Func2<A, A, A> sum) {
   ...
   */
  public static final Semigroup<Integer> intAdditionSemigroup = semigroup(new Func2<Integer, Integer, Integer>() {
   ...
   */
  public static final Semigroup<Double> doubleAdditionSemigroup = semigroup(new Func2<Double, Double, Double>() {
   ...
   */
  public static final Semigroup<Integer> intMultiplicationSemigroup = semigroup(new Func2<Integer, Integer, Integer>() {
    public Integer f(final Integer i1, final Integer i2) {
      return i1 * i2;
    }
  });
   ...
   */
  public static final Semigroup<Double> doubleMultiplicationSemigroup = semigroup(new Func2<Double, Double, Double>() {
    public Double f(final Double d1, final Double d2) {
      return d1 * d2;
    }
  });
  ...
  public static final Semigroup<BigInteger> bigintAdditionSemigroup =
      semigroup(new Func2<BigInteger, BigInteger, BigInteger>() {
  ...
  public static final Semigroup<BigDecimal> bigdecimalAdditionSemigroup =
      semigroup(new Func2<BigDecimal, BigDecimal, BigDecimal>() {
  ...
  public static final Semigroup<Natural> naturalMultiplicationSemigroup =
      semigroup(new Func2<Natural, Natural, Natural>() {
   ...
   */
  public static final Semigroup<Long> longAdditionSemigroup = semigroup(new Func2<Long, Long, Long>() {
   ...
   */
  public static final Semigroup<Long> longMultiplicationSemigroup = semigroup(new Func2<Long, Long, Long>() {
    public Long f(final Long x, final Long y) {
      return x * y;
    }
  });
   ...
   */
  public static final Semigroup<Boolean> disjunctionSemigroup = semigroup(new Func2<Boolean, Boolean, Boolean>() {
   ...
   */
  public static final Semigroup<Boolean> exclusiveDisjunctionSemiGroup = semigroup(new Func2<Boolean, Boolean, Boolean>() {
   ...
   */
  public static final Semigroup<Boolean> conjunctionSemigroup = semigroup(new Func2<Boolean, Boolean, Boolean>() {
    public Boolean f(final Boolean b1, final Boolean b2) {
      return b1 && b2;
    }
  });
   ...
   */
  public static final Semigroup<String> stringSemigroup = semigroup(new Func2<String, String, String>() {
  ...
  public static final Semigroup<StringBuffer> stringBufferSemigroup =
      semigroup(new Func2<StringBuffer, StringBuffer, StringBuffer>() {
  ...
  public static final Semigroup<StringBuilder> stringBuilderSemigroup =
      semigroup(new Func2<StringBuilder, StringBuilder, StringBuilder>() {
   ...
   */
  public static <A, B> Semigroup<Func<A, B>> functionSemigroup(final Semigroup<B> sb) {
    return semigroup(new Func2<Func<A, B>, Func<A, B>, Func<A, B>>() {
      public Func<A, B> f(final Func<A, B> a1, final Func<A, B> a2) {
        return new Func<A, B>() {
  ...
  public static <A> Semigroup<List<A>> listSemigroup() {
    return semigroup(new Func2<List<A>, List<A>, List<A>>() {
  ...
  public static <A> Semigroup<NonEmptyList<A>> nonEmptyListSemigroup() {
    return semigroup(new Func2<NonEmptyList<A>, NonEmptyList<A>, NonEmptyList<A>>() {
  ...
  public static <A> Semigroup<Option<A>> optionSemigroup() {
    return semigroup(new Func2<Option<A>, Option<A>, Option<A>>() {
  ...
  public static <A> Semigroup<Stream<A>> streamSemigroup() {
    return semigroup(new Func2<Stream<A>, Stream<A>, Stream<A>>() {
  ...
  public static <A> Semigroup<Array<A>> arraySemigroup() {
    return semigroup(new Func2<Array<A>, Array<A>, Array<A>>() {
  ...
  public static <A> Semigroup<P1<A>> p1Semigroup(final Semigroup<A> sa) {
    return semigroup(new Func2<P1<A>, P1<A>, P1<A>>() {
  ...
  public static <A, B> Semigroup<P2<A, B>> p2Semigroup(final Semigroup<A> sa, final Semigroup<B> sb) {
    return semigroup(new Func2<P2<A, B>, P2<A, B>, P2<A, B>>() {
   ...
   */
  public static final Semigroup<Unit> unitSemigroup = semigroup(new Func2<Unit, Unit, Unit>() {
  ...
  public static <A> Semigroup<Set<A>> setSemigroup() {
    return semigroup(new Func2<Set<A>, Set<A>, Set<A>>() {
