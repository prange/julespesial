...
public abstract class P6<A, B, C, D, E, F> {
   ...
   */
  public final <X> P6<X, B, C, D, E, F> map1(final Func<A, X> f) {
   ...
   * @return A product with the given function applied.
   */
  public final <X> P6<A, X, C, D, E, F> map2(final Func<B, X> f) {
   ...
   * @return A product with the given function applied.
   */
  public final <X> P6<A, B, X, D, E, F> map3(final Func<C, X> f) {
   ...
   * @return A product with the given function applied.
   */
  public final <X> P6<A, B, C, X, E, F> map4(final Func<D, X> f) {
   ...
   * @return A product with the given function applied.
   */
  public final <X> P6<A, B, C, D, X, F> map5(final Func<E, X> f) {
   ...
   * @return A product with the given function applied.
   */
  public final <X> P6<A, B, C, D, E, X> map6(final Func<F, X> f) {
   ...
   */
  public static <A, B, C, D, E, F$> Func<P6<A, B, C, D, E, F$>, A> __1() {
    return new Func<P6<A, B, C, D, E, F$>, A>() {
   ...
   */
  public static <A, B, C, D, E, F$> Func<P6<A, B, C, D, E, F$>, B> __2() {
    return new Func<P6<A, B, C, D, E, F$>, B>() {
   ...
   */
  public static <A, B, C, D, E, F$> Func<P6<A, B, C, D, E, F$>, C> __3() {
    return new Func<P6<A, B, C, D, E, F$>, C>() {
   ...
   */
  public static <A, B, C, D, E, F$> Func<P6<A, B, C, D, E, F$>, D> __4() {
    return new Func<P6<A, B, C, D, E, F$>, D>() {
   ...
   */
  public static <A, B, C, D, E, F$> Func<P6<A, B, C, D, E, F$>, E> __5() {
    return new Func<P6<A, B, C, D, E, F$>, E>() {
   ...
   */
  public static <A, B, C, D, E, F$> Func<P6<A, B, C, D, E, F$>, F$> __6() {
    return new Func<P6<A, B, C, D, E, F$>, F$>() {
